...
parser NomoptionsIttoClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NomoptionsIttoClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NomoptionsIttoClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NomoptionsIttoClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NomoptionsIttoClientParser(),
    NomoptionsIttoClientVerifyChecksum(),
    NomoptionsIttoClientIngress(),
    NomoptionsIttoClientEgress(),
    NomoptionsIttoClientComputeChecksum(),
    NomoptionsIttoClientDeparser()
) main;
