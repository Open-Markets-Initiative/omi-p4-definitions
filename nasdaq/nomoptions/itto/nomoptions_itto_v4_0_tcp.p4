...
parser NomoptionsIttoTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NomoptionsIttoTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NomoptionsIttoTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NomoptionsIttoTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NomoptionsIttoTcpParser(),
    NomoptionsIttoTcpVerifyChecksum(),
    NomoptionsIttoTcpIngress(),
    NomoptionsIttoTcpEgress(),
    NomoptionsIttoTcpComputeChecksum(),
    NomoptionsIttoTcpDeparser()
) main;
