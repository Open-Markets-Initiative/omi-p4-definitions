...
struct headers_t {
    ...
    add_order_message_short_message_form_t add_order_message_short_message_form[MAX_MESSAGES];
    add_order_message_long_form_message_t add_order_message_long_form_message[MAX_MESSAGES];
    add_quote_message_short_form_message_t add_quote_message_short_form_message[MAX_MESSAGES];
    add_quote_message_long_form_message_t add_quote_message_long_form_message[MAX_MESSAGES];
    ...
    single_side_change_message_t single_side_change_message[MAX_MESSAGES];
    quote_replace_message_short_form_t quote_replace_message_short_form[MAX_MESSAGES];
    quote_replace_message_long_form_t quote_replace_message_long_form[MAX_MESSAGES];
    quote_delete_message_t quote_delete_message[MAX_MESSAGES];
    options_trade_messages_non_auction_t options_trade_messages_non_auction[MAX_MESSAGES];
...
parser NomoptionsIttoUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NomoptionsIttoUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NomoptionsIttoUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NomoptionsIttoUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NomoptionsIttoUdpParser(),
    NomoptionsIttoUdpVerifyChecksum(),
    NomoptionsIttoUdpIngress(),
    NomoptionsIttoUdpEgress(),
    NomoptionsIttoUdpComputeChecksum(),
    NomoptionsIttoUdpDeparser()
) main;
