...
control NomoptionsIttoMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control NomoptionsIttoMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NomoptionsIttoMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NomoptionsIttoMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NomoptionsIttoMoldudp64Parser(),
    NomoptionsIttoMoldudp64VerifyChecksum(),
    NomoptionsIttoMoldudp64Ingress(),
    NomoptionsIttoMoldudp64Egress(),
    NomoptionsIttoMoldudp64ComputeChecksum(),
    NomoptionsIttoMoldudp64Deparser()
) main;
