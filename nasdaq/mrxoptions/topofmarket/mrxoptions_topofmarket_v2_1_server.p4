...
parser MrxoptionsTopofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsTopofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTopofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsTopofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsTopofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTopofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsTopofmarketServerParser(),
    MrxoptionsTopofmarketServerVerifyChecksum(),
    MrxoptionsTopofmarketServerIngress(),
    MrxoptionsTopofmarketServerEgress(),
    MrxoptionsTopofmarketServerComputeChecksum(),
    MrxoptionsTopofmarketServerDeparser()
) main;
