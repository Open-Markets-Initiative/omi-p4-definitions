...
control MrxoptionsTopofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTopofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsTopofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsTopofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTopofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsTopofmarketMoldudp64Parser(),
    MrxoptionsTopofmarketMoldudp64VerifyChecksum(),
    MrxoptionsTopofmarketMoldudp64Ingress(),
    MrxoptionsTopofmarketMoldudp64Egress(),
    MrxoptionsTopofmarketMoldudp64ComputeChecksum(),
    MrxoptionsTopofmarketMoldudp64Deparser()
) main;
