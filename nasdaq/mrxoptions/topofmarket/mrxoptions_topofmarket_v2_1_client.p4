...
parser MrxoptionsTopofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsTopofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTopofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsTopofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsTopofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTopofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsTopofmarketClientParser(),
    MrxoptionsTopofmarketClientVerifyChecksum(),
    MrxoptionsTopofmarketClientIngress(),
    MrxoptionsTopofmarketClientEgress(),
    MrxoptionsTopofmarketClientComputeChecksum(),
    MrxoptionsTopofmarketClientDeparser()
) main;
