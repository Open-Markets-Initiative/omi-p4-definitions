...
parser MrxoptionsOrderfeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsOrderfeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsOrderfeedServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsOrderfeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsOrderfeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsOrderfeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsOrderfeedServertcpParser(),
    MrxoptionsOrderfeedServertcpVerifyChecksum(),
    MrxoptionsOrderfeedServertcpIngress(),
    MrxoptionsOrderfeedServertcpEgress(),
    MrxoptionsOrderfeedServertcpComputeChecksum(),
    MrxoptionsOrderfeedServertcpDeparser()
) main;
