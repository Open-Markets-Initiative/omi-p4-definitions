...
parser MrxoptionsOrderfeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsOrderfeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsOrderfeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsOrderfeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsOrderfeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsOrderfeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsOrderfeedClientParser(),
    MrxoptionsOrderfeedClientVerifyChecksum(),
    MrxoptionsOrderfeedClientIngress(),
    MrxoptionsOrderfeedClientEgress(),
    MrxoptionsOrderfeedClientComputeChecksum(),
    MrxoptionsOrderfeedClientDeparser()
) main;
