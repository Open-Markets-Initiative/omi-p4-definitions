...
parser MrxoptionsOrderfeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsOrderfeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsOrderfeedMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsOrderfeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsOrderfeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsOrderfeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsOrderfeedMoldudp64Parser(),
    MrxoptionsOrderfeedMoldudp64VerifyChecksum(),
    MrxoptionsOrderfeedMoldudp64Ingress(),
    MrxoptionsOrderfeedMoldudp64Egress(),
    MrxoptionsOrderfeedMoldudp64ComputeChecksum(),
    MrxoptionsOrderfeedMoldudp64Deparser()
) main;
