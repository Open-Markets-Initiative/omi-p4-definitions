// P4_16 (v1model) definition for: Nasdaq MrxOptions SpreadOrders Itch v2.1
// 
// Protocol:
...
parser MrxoptionsSpreadordersMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadordersMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadordersMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadordersMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadordersMoldudp64Parser(),
    MrxoptionsSpreadordersMoldudp64VerifyChecksum(),
    MrxoptionsSpreadordersMoldudp64Ingress(),
    MrxoptionsSpreadordersMoldudp64Egress(),
    MrxoptionsSpreadordersMoldudp64ComputeChecksum(),
    MrxoptionsSpreadordersMoldudp64Deparser()
) main;
