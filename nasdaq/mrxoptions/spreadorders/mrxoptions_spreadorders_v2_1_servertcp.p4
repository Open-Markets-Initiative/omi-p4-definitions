...
parser MrxoptionsSpreadordersServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadordersServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadordersServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadordersServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadordersServertcpParser(),
    MrxoptionsSpreadordersServertcpVerifyChecksum(),
    MrxoptionsSpreadordersServertcpIngress(),
    MrxoptionsSpreadordersServertcpEgress(),
    MrxoptionsSpreadordersServertcpComputeChecksum(),
    MrxoptionsSpreadordersServertcpDeparser()
) main;
