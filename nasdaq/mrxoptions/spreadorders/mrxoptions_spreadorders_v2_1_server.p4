...
parser MrxoptionsSpreadordersServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadordersServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadordersServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadordersServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadordersServerParser(),
    MrxoptionsSpreadordersServerVerifyChecksum(),
    MrxoptionsSpreadordersServerIngress(),
    MrxoptionsSpreadordersServerEgress(),
    MrxoptionsSpreadordersServerComputeChecksum(),
    MrxoptionsSpreadordersServerDeparser()
) main;
