...
parser MrxoptionsSpreadordersUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadordersUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadordersUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadordersUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadordersUdpParser(),
    MrxoptionsSpreadordersUdpVerifyChecksum(),
    MrxoptionsSpreadordersUdpIngress(),
    MrxoptionsSpreadordersUdpEgress(),
    MrxoptionsSpreadordersUdpComputeChecksum(),
    MrxoptionsSpreadordersUdpDeparser()
) main;
