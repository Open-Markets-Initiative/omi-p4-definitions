...
parser MrxoptionsSpreadordersClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadordersClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadordersClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadordersClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadordersClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadordersClientParser(),
    MrxoptionsSpreadordersClientVerifyChecksum(),
    MrxoptionsSpreadordersClientIngress(),
    MrxoptionsSpreadordersClientEgress(),
    MrxoptionsSpreadordersClientComputeChecksum(),
    MrxoptionsSpreadordersClientDeparser()
) main;
