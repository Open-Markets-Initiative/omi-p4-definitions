...
parser MrxoptionsSpreaddepthofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
    ...
    state parse_complex_strategy_auction_message {
        ...
        meta.dispatched = 1;
        meta.complex_strategy_auction_message_flex_dac_leg_information_remaining = hdr.complex_strategy_auction_message.number_of_flex_dac_legs;
...
control MrxoptionsSpreaddepthofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreaddepthofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreaddepthofmarketServertcpParser(),
    MrxoptionsSpreaddepthofmarketServertcpVerifyChecksum(),
    MrxoptionsSpreaddepthofmarketServertcpIngress(),
    MrxoptionsSpreaddepthofmarketServertcpEgress(),
    MrxoptionsSpreaddepthofmarketServertcpComputeChecksum(),
    MrxoptionsSpreaddepthofmarketServertcpDeparser()
) main;
