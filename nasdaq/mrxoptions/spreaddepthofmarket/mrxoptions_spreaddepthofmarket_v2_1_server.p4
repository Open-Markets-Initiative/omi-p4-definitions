...
parser MrxoptionsSpreaddepthofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreaddepthofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreaddepthofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreaddepthofmarketServerParser(),
    MrxoptionsSpreaddepthofmarketServerVerifyChecksum(),
    MrxoptionsSpreaddepthofmarketServerIngress(),
    MrxoptionsSpreaddepthofmarketServerEgress(),
    MrxoptionsSpreaddepthofmarketServerComputeChecksum(),
    MrxoptionsSpreaddepthofmarketServerDeparser()
) main;
