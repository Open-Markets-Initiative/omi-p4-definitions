// P4_16 (v1model) definition for: Nasdaq MrxOptions SpreadDepthOfMarket Itch v2.1
// 
// Protocol:
...
parser MrxoptionsSpreaddepthofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreaddepthofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreaddepthofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreaddepthofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreaddepthofmarketMoldudp64Parser(),
    MrxoptionsSpreaddepthofmarketMoldudp64VerifyChecksum(),
    MrxoptionsSpreaddepthofmarketMoldudp64Ingress(),
    MrxoptionsSpreaddepthofmarketMoldudp64Egress(),
    MrxoptionsSpreaddepthofmarketMoldudp64ComputeChecksum(),
    MrxoptionsSpreaddepthofmarketMoldudp64Deparser()
) main;
