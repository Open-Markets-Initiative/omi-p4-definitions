...
parser MrxoptionsSpreadtradefeedClienttcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadtradefeedClienttcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedClienttcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsSpreadtradefeedClienttcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedClienttcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedClienttcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadtradefeedClienttcpParser(),
    MrxoptionsSpreadtradefeedClienttcpVerifyChecksum(),
    MrxoptionsSpreadtradefeedClienttcpIngress(),
    MrxoptionsSpreadtradefeedClienttcpEgress(),
    MrxoptionsSpreadtradefeedClienttcpComputeChecksum(),
    MrxoptionsSpreadtradefeedClienttcpDeparser()
) main;
