...
parser MrxoptionsSpreadtradefeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadtradefeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadtradefeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadtradefeedClientParser(),
    MrxoptionsSpreadtradefeedClientVerifyChecksum(),
    MrxoptionsSpreadtradefeedClientIngress(),
    MrxoptionsSpreadtradefeedClientEgress(),
    MrxoptionsSpreadtradefeedClientComputeChecksum(),
    MrxoptionsSpreadtradefeedClientDeparser()
) main;
