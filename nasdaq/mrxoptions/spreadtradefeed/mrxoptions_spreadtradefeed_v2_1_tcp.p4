...
parser MrxoptionsSpreadtradefeedTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadtradefeedTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsSpreadtradefeedTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtradefeedTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadtradefeedTcpParser(),
    MrxoptionsSpreadtradefeedTcpVerifyChecksum(),
    MrxoptionsSpreadtradefeedTcpIngress(),
    MrxoptionsSpreadtradefeedTcpEgress(),
    MrxoptionsSpreadtradefeedTcpComputeChecksum(),
    MrxoptionsSpreadtradefeedTcpDeparser()
) main;
