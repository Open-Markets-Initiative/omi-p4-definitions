...
parser MrxoptionsSpreadtopofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadtopofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadtopofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadtopofmarketServerParser(),
    MrxoptionsSpreadtopofmarketServerVerifyChecksum(),
    MrxoptionsSpreadtopofmarketServerIngress(),
    MrxoptionsSpreadtopofmarketServerEgress(),
    MrxoptionsSpreadtopofmarketServerComputeChecksum(),
    MrxoptionsSpreadtopofmarketServerDeparser()
) main;
