...
parser MrxoptionsSpreadtopofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadtopofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsSpreadtopofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadtopofmarketClientParser(),
    MrxoptionsSpreadtopofmarketClientVerifyChecksum(),
    MrxoptionsSpreadtopofmarketClientIngress(),
    MrxoptionsSpreadtopofmarketClientEgress(),
    MrxoptionsSpreadtopofmarketClientComputeChecksum(),
    MrxoptionsSpreadtopofmarketClientDeparser()
) main;
