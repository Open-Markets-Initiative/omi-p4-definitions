...
parser MrxoptionsSpreadtopofmarketUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsSpreadtopofmarketUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsSpreadtopofmarketUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsSpreadtopofmarketUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsSpreadtopofmarketUdpParser(),
    MrxoptionsSpreadtopofmarketUdpVerifyChecksum(),
    MrxoptionsSpreadtopofmarketUdpIngress(),
    MrxoptionsSpreadtopofmarketUdpEgress(),
    MrxoptionsSpreadtopofmarketUdpComputeChecksum(),
    MrxoptionsSpreadtopofmarketUdpDeparser()
) main;
