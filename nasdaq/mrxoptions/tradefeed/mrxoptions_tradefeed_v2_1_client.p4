...
parser MrxoptionsTradefeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsTradefeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTradefeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsTradefeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsTradefeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTradefeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsTradefeedClientParser(),
    MrxoptionsTradefeedClientVerifyChecksum(),
    MrxoptionsTradefeedClientIngress(),
    MrxoptionsTradefeedClientEgress(),
    MrxoptionsTradefeedClientComputeChecksum(),
    MrxoptionsTradefeedClientDeparser()
) main;
