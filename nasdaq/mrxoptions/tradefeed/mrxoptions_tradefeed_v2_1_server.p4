...
parser MrxoptionsTradefeedServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsTradefeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTradefeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsTradefeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsTradefeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsTradefeedServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsTradefeedServerParser(),
    MrxoptionsTradefeedServerVerifyChecksum(),
    MrxoptionsTradefeedServerIngress(),
    MrxoptionsTradefeedServerEgress(),
    MrxoptionsTradefeedServerComputeChecksum(),
    MrxoptionsTradefeedServerDeparser()
) main;
