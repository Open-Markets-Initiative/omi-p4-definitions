...
parser MrxoptionsDepthofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsDepthofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsDepthofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsDepthofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsDepthofmarketClientParser(),
    MrxoptionsDepthofmarketClientVerifyChecksum(),
    MrxoptionsDepthofmarketClientIngress(),
    MrxoptionsDepthofmarketClientEgress(),
    MrxoptionsDepthofmarketClientComputeChecksum(),
    MrxoptionsDepthofmarketClientDeparser()
) main;
