...
control MrxoptionsDepthofmarketUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsDepthofmarketUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsDepthofmarketUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    MrxoptionsDepthofmarketUdpParser(),
    MrxoptionsDepthofmarketUdpVerifyChecksum(),
    MrxoptionsDepthofmarketUdpIngress(),
    MrxoptionsDepthofmarketUdpEgress(),
    MrxoptionsDepthofmarketUdpComputeChecksum(),
    MrxoptionsDepthofmarketUdpDeparser()
) main;
