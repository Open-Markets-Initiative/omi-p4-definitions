...
parser MrxoptionsDepthofmarketClienttcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsDepthofmarketClienttcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketClienttcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsDepthofmarketClienttcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsDepthofmarketClienttcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketClienttcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsDepthofmarketClienttcpParser(),
    MrxoptionsDepthofmarketClienttcpVerifyChecksum(),
    MrxoptionsDepthofmarketClienttcpIngress(),
    MrxoptionsDepthofmarketClienttcpEgress(),
    MrxoptionsDepthofmarketClienttcpComputeChecksum(),
    MrxoptionsDepthofmarketClienttcpDeparser()
) main;
