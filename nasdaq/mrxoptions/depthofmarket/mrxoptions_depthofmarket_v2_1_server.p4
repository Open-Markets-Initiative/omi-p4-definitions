...
parser MrxoptionsDepthofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MrxoptionsDepthofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MrxoptionsDepthofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsDepthofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsDepthofmarketServerParser(),
    MrxoptionsDepthofmarketServerVerifyChecksum(),
    MrxoptionsDepthofmarketServerIngress(),
    MrxoptionsDepthofmarketServerEgress(),
    MrxoptionsDepthofmarketServerComputeChecksum(),
    MrxoptionsDepthofmarketServerDeparser()
) main;
