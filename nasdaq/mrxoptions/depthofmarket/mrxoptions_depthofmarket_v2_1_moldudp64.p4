...
control MrxoptionsDepthofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control MrxoptionsDepthofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MrxoptionsDepthofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MrxoptionsDepthofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MrxoptionsDepthofmarketMoldudp64Parser(),
    MrxoptionsDepthofmarketMoldudp64VerifyChecksum(),
    MrxoptionsDepthofmarketMoldudp64Ingress(),
    MrxoptionsDepthofmarketMoldudp64Egress(),
    MrxoptionsDepthofmarketMoldudp64ComputeChecksum(),
    MrxoptionsDepthofmarketMoldudp64Deparser()
) main;
