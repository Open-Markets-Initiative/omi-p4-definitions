...
parser NtxoptionsDepthofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsDepthofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsDepthofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NtxoptionsDepthofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsDepthofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsDepthofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsDepthofmarketMoldudp64Parser(),
    NtxoptionsDepthofmarketMoldudp64VerifyChecksum(),
    NtxoptionsDepthofmarketMoldudp64Ingress(),
    NtxoptionsDepthofmarketMoldudp64Egress(),
    NtxoptionsDepthofmarketMoldudp64ComputeChecksum(),
    NtxoptionsDepthofmarketMoldudp64Deparser()
) main;
