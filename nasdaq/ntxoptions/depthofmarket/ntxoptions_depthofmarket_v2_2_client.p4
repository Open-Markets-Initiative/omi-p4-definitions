...
parser NtxoptionsDepthofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsDepthofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsDepthofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NtxoptionsDepthofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsDepthofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsDepthofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsDepthofmarketClientParser(),
    NtxoptionsDepthofmarketClientVerifyChecksum(),
    NtxoptionsDepthofmarketClientIngress(),
    NtxoptionsDepthofmarketClientEgress(),
    NtxoptionsDepthofmarketClientComputeChecksum(),
    NtxoptionsDepthofmarketClientDeparser()
) main;
