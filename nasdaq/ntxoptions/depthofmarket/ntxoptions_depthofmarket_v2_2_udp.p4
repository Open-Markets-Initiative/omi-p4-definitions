...
parser NtxoptionsDepthofmarketUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsDepthofmarketUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsDepthofmarketUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NtxoptionsDepthofmarketUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsDepthofmarketUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsDepthofmarketUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsDepthofmarketUdpParser(),
    NtxoptionsDepthofmarketUdpVerifyChecksum(),
    NtxoptionsDepthofmarketUdpIngress(),
    NtxoptionsDepthofmarketUdpEgress(),
    NtxoptionsDepthofmarketUdpComputeChecksum(),
    NtxoptionsDepthofmarketUdpDeparser()
) main;
