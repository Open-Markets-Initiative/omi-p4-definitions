...
parser NtxoptionsTopofmarketUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsTopofmarketUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTopofmarketUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NtxoptionsTopofmarketUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsTopofmarketUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTopofmarketUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsTopofmarketUdpParser(),
    NtxoptionsTopofmarketUdpVerifyChecksum(),
    NtxoptionsTopofmarketUdpIngress(),
    NtxoptionsTopofmarketUdpEgress(),
    NtxoptionsTopofmarketUdpComputeChecksum(),
    NtxoptionsTopofmarketUdpDeparser()
) main;
