...
parser NtxoptionsTopofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsTopofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTopofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NtxoptionsTopofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsTopofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTopofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsTopofmarketServerParser(),
    NtxoptionsTopofmarketServerVerifyChecksum(),
    NtxoptionsTopofmarketServerIngress(),
    NtxoptionsTopofmarketServerEgress(),
    NtxoptionsTopofmarketServerComputeChecksum(),
    NtxoptionsTopofmarketServerDeparser()
) main;
