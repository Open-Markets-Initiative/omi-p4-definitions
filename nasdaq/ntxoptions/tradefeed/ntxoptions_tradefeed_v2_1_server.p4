...
parser NtxoptionsTradefeedServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsTradefeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTradefeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NtxoptionsTradefeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsTradefeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTradefeedServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsTradefeedServerParser(),
    NtxoptionsTradefeedServerVerifyChecksum(),
    NtxoptionsTradefeedServerIngress(),
    NtxoptionsTradefeedServerEgress(),
    NtxoptionsTradefeedServerComputeChecksum(),
    NtxoptionsTradefeedServerDeparser()
) main;
