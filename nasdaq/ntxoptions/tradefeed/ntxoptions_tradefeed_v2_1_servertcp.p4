...
parser NtxoptionsTradefeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsTradefeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control NtxoptionsTradefeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsTradefeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTradefeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsTradefeedServertcpParser(),
    NtxoptionsTradefeedServertcpVerifyChecksum(),
    NtxoptionsTradefeedServertcpIngress(),
    NtxoptionsTradefeedServertcpEgress(),
    NtxoptionsTradefeedServertcpComputeChecksum(),
    NtxoptionsTradefeedServertcpDeparser()
) main;
