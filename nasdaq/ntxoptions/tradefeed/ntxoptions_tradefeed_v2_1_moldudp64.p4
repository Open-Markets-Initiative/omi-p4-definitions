...
parser NtxoptionsTradefeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxoptionsTradefeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTradefeedMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NtxoptionsTradefeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxoptionsTradefeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxoptionsTradefeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxoptionsTradefeedMoldudp64Parser(),
    NtxoptionsTradefeedMoldudp64VerifyChecksum(),
    NtxoptionsTradefeedMoldudp64Ingress(),
    NtxoptionsTradefeedMoldudp64Egress(),
    NtxoptionsTradefeedMoldudp64ComputeChecksum(),
    NtxoptionsTradefeedMoldudp64Deparser()
) main;
