...
parser IseoptionsOrderfeedServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsOrderfeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsOrderfeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsOrderfeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsOrderfeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsOrderfeedServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsOrderfeedServerParser(),
    IseoptionsOrderfeedServerVerifyChecksum(),
    IseoptionsOrderfeedServerIngress(),
    IseoptionsOrderfeedServerEgress(),
    IseoptionsOrderfeedServerComputeChecksum(),
    IseoptionsOrderfeedServerDeparser()
) main;
