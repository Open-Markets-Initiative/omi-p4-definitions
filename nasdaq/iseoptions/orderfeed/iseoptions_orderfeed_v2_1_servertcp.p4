...
parser IseoptionsOrderfeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsOrderfeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsOrderfeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsOrderfeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsOrderfeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsOrderfeedServertcpParser(),
    IseoptionsOrderfeedServertcpVerifyChecksum(),
    IseoptionsOrderfeedServertcpIngress(),
    IseoptionsOrderfeedServertcpEgress(),
    IseoptionsOrderfeedServertcpComputeChecksum(),
    IseoptionsOrderfeedServertcpDeparser()
) main;
