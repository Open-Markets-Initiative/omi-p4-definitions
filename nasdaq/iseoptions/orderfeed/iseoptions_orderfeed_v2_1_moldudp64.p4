...
parser IseoptionsOrderfeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsOrderfeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsOrderfeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsOrderfeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsOrderfeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsOrderfeedMoldudp64Parser(),
    IseoptionsOrderfeedMoldudp64VerifyChecksum(),
    IseoptionsOrderfeedMoldudp64Ingress(),
    IseoptionsOrderfeedMoldudp64Egress(),
    IseoptionsOrderfeedMoldudp64ComputeChecksum(),
    IseoptionsOrderfeedMoldudp64Deparser()
) main;
