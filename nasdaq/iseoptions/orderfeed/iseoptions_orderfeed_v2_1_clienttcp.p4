...
parser IseoptionsOrderfeedClienttcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsOrderfeedClienttcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsOrderfeedClienttcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsOrderfeedClienttcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsOrderfeedClienttcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsOrderfeedClienttcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsOrderfeedClienttcpParser(),
    IseoptionsOrderfeedClienttcpVerifyChecksum(),
    IseoptionsOrderfeedClienttcpIngress(),
    IseoptionsOrderfeedClienttcpEgress(),
    IseoptionsOrderfeedClienttcpComputeChecksum(),
    IseoptionsOrderfeedClienttcpDeparser()
) main;
