...
parser IseoptionsSpreadtopofmarketTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtopofmarketTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsSpreadtopofmarketTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtopofmarketTcpParser(),
    IseoptionsSpreadtopofmarketTcpVerifyChecksum(),
    IseoptionsSpreadtopofmarketTcpIngress(),
    IseoptionsSpreadtopofmarketTcpEgress(),
    IseoptionsSpreadtopofmarketTcpComputeChecksum(),
    IseoptionsSpreadtopofmarketTcpDeparser()
) main;
