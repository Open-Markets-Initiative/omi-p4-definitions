...
parser IseoptionsSpreadtopofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtopofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsSpreadtopofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtopofmarketMoldudp64Parser(),
    IseoptionsSpreadtopofmarketMoldudp64VerifyChecksum(),
    IseoptionsSpreadtopofmarketMoldudp64Ingress(),
    IseoptionsSpreadtopofmarketMoldudp64Egress(),
    IseoptionsSpreadtopofmarketMoldudp64ComputeChecksum(),
    IseoptionsSpreadtopofmarketMoldudp64Deparser()
) main;
