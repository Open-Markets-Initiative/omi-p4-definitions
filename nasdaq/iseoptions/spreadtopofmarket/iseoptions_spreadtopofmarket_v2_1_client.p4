...
parser IseoptionsSpreadtopofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtopofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreadtopofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtopofmarketClientParser(),
    IseoptionsSpreadtopofmarketClientVerifyChecksum(),
    IseoptionsSpreadtopofmarketClientIngress(),
    IseoptionsSpreadtopofmarketClientEgress(),
    IseoptionsSpreadtopofmarketClientComputeChecksum(),
    IseoptionsSpreadtopofmarketClientDeparser()
) main;
