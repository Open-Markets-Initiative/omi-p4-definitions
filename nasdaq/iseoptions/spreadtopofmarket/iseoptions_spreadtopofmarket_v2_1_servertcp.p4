...
parser IseoptionsSpreadtopofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtopofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsSpreadtopofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtopofmarketServertcpParser(),
    IseoptionsSpreadtopofmarketServertcpVerifyChecksum(),
    IseoptionsSpreadtopofmarketServertcpIngress(),
    IseoptionsSpreadtopofmarketServertcpEgress(),
    IseoptionsSpreadtopofmarketServertcpComputeChecksum(),
    IseoptionsSpreadtopofmarketServertcpDeparser()
) main;
