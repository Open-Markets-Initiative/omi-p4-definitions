...
parser IseoptionsSpreadtopofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtopofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreadtopofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtopofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtopofmarketServerParser(),
    IseoptionsSpreadtopofmarketServerVerifyChecksum(),
    IseoptionsSpreadtopofmarketServerIngress(),
    IseoptionsSpreadtopofmarketServerEgress(),
    IseoptionsSpreadtopofmarketServerComputeChecksum(),
    IseoptionsSpreadtopofmarketServerDeparser()
) main;
