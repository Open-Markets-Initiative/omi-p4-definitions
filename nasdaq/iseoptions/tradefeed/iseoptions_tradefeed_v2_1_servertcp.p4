...
parser IseoptionsTradefeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsTradefeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTradefeedServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsTradefeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsTradefeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTradefeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsTradefeedServertcpParser(),
    IseoptionsTradefeedServertcpVerifyChecksum(),
    IseoptionsTradefeedServertcpIngress(),
    IseoptionsTradefeedServertcpEgress(),
    IseoptionsTradefeedServertcpComputeChecksum(),
    IseoptionsTradefeedServertcpDeparser()
) main;
