...
parser IseoptionsTradefeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsTradefeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsTradefeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsTradefeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTradefeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsTradefeedMoldudp64Parser(),
    IseoptionsTradefeedMoldudp64VerifyChecksum(),
    IseoptionsTradefeedMoldudp64Ingress(),
    IseoptionsTradefeedMoldudp64Egress(),
    IseoptionsTradefeedMoldudp64ComputeChecksum(),
    IseoptionsTradefeedMoldudp64Deparser()
) main;
