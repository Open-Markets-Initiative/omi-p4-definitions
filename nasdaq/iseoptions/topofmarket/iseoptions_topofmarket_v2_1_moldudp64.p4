...
parser IseoptionsTopofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsTopofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsTopofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsTopofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsTopofmarketMoldudp64Parser(),
    IseoptionsTopofmarketMoldudp64VerifyChecksum(),
    IseoptionsTopofmarketMoldudp64Ingress(),
    IseoptionsTopofmarketMoldudp64Egress(),
    IseoptionsTopofmarketMoldudp64ComputeChecksum(),
    IseoptionsTopofmarketMoldudp64Deparser()
) main;
