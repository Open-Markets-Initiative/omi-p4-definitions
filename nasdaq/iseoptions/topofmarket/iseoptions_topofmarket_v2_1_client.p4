...
parser IseoptionsTopofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsTopofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsTopofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsTopofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsTopofmarketClientParser(),
    IseoptionsTopofmarketClientVerifyChecksum(),
    IseoptionsTopofmarketClientIngress(),
    IseoptionsTopofmarketClientEgress(),
    IseoptionsTopofmarketClientComputeChecksum(),
    IseoptionsTopofmarketClientDeparser()
) main;
