...
parser IseoptionsTopofmarketUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsTopofmarketUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsTopofmarketUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsTopofmarketUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsTopofmarketUdpParser(),
    IseoptionsTopofmarketUdpVerifyChecksum(),
    IseoptionsTopofmarketUdpIngress(),
    IseoptionsTopofmarketUdpEgress(),
    IseoptionsTopofmarketUdpComputeChecksum(),
    IseoptionsTopofmarketUdpDeparser()
) main;
