...
control IseoptionsTopofmarketClienttcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketClienttcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsTopofmarketClienttcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsTopofmarketClienttcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsTopofmarketClienttcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsTopofmarketClienttcpParser(),
    IseoptionsTopofmarketClienttcpVerifyChecksum(),
    IseoptionsTopofmarketClienttcpIngress(),
    IseoptionsTopofmarketClienttcpEgress(),
    IseoptionsTopofmarketClienttcpComputeChecksum(),
    IseoptionsTopofmarketClienttcpDeparser()
) main;
