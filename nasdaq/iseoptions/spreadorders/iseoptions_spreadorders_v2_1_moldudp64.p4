...
parser IseoptionsSpreadordersMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadordersMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadordersMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreadordersMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadordersMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadordersMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadordersMoldudp64Parser(),
    IseoptionsSpreadordersMoldudp64VerifyChecksum(),
    IseoptionsSpreadordersMoldudp64Ingress(),
    IseoptionsSpreadordersMoldudp64Egress(),
    IseoptionsSpreadordersMoldudp64ComputeChecksum(),
    IseoptionsSpreadordersMoldudp64Deparser()
) main;
