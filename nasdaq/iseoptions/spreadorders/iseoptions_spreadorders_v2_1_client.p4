...
parser IseoptionsSpreadordersClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadordersClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadordersClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreadordersClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadordersClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadordersClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadordersClientParser(),
    IseoptionsSpreadordersClientVerifyChecksum(),
    IseoptionsSpreadordersClientIngress(),
    IseoptionsSpreadordersClientEgress(),
    IseoptionsSpreadordersClientComputeChecksum(),
    IseoptionsSpreadordersClientDeparser()
) main;
