...
parser IseoptionsDepthofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsDepthofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsDepthofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsDepthofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsDepthofmarketServertcpParser(),
    IseoptionsDepthofmarketServertcpVerifyChecksum(),
    IseoptionsDepthofmarketServertcpIngress(),
    IseoptionsDepthofmarketServertcpEgress(),
    IseoptionsDepthofmarketServertcpComputeChecksum(),
    IseoptionsDepthofmarketServertcpDeparser()
) main;
