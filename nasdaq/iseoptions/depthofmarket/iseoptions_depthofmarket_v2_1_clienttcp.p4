...
parser IseoptionsDepthofmarketClienttcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsDepthofmarketClienttcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketClienttcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsDepthofmarketClienttcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsDepthofmarketClienttcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketClienttcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsDepthofmarketClienttcpParser(),
    IseoptionsDepthofmarketClienttcpVerifyChecksum(),
    IseoptionsDepthofmarketClienttcpIngress(),
    IseoptionsDepthofmarketClienttcpEgress(),
    IseoptionsDepthofmarketClienttcpComputeChecksum(),
    IseoptionsDepthofmarketClienttcpDeparser()
) main;
