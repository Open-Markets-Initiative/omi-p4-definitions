...
parser IseoptionsDepthofmarketTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsDepthofmarketTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsDepthofmarketTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsDepthofmarketTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsDepthofmarketTcpParser(),
    IseoptionsDepthofmarketTcpVerifyChecksum(),
    IseoptionsDepthofmarketTcpIngress(),
    IseoptionsDepthofmarketTcpEgress(),
    IseoptionsDepthofmarketTcpComputeChecksum(),
    IseoptionsDepthofmarketTcpDeparser()
) main;
