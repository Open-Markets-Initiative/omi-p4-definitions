...
parser IseoptionsDepthofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsDepthofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsDepthofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsDepthofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsDepthofmarketMoldudp64Parser(),
    IseoptionsDepthofmarketMoldudp64VerifyChecksum(),
    IseoptionsDepthofmarketMoldudp64Ingress(),
    IseoptionsDepthofmarketMoldudp64Egress(),
    IseoptionsDepthofmarketMoldudp64ComputeChecksum(),
    IseoptionsDepthofmarketMoldudp64Deparser()
) main;
