...
parser IseoptionsDepthofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsDepthofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsDepthofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsDepthofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsDepthofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsDepthofmarketServerParser(),
    IseoptionsDepthofmarketServerVerifyChecksum(),
    IseoptionsDepthofmarketServerIngress(),
    IseoptionsDepthofmarketServerEgress(),
    IseoptionsDepthofmarketServerComputeChecksum(),
    IseoptionsDepthofmarketServerDeparser()
) main;
