// P4_16 (v1model) definition for: Nasdaq IseOptions SpreadTradeFeed Itch v2.1
// 
// Protocol:
...
parser IseoptionsSpreadtradefeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtradefeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsSpreadtradefeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtradefeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtradefeedMoldudp64Parser(),
    IseoptionsSpreadtradefeedMoldudp64VerifyChecksum(),
    IseoptionsSpreadtradefeedMoldudp64Ingress(),
    IseoptionsSpreadtradefeedMoldudp64Egress(),
    IseoptionsSpreadtradefeedMoldudp64ComputeChecksum(),
    IseoptionsSpreadtradefeedMoldudp64Deparser()
) main;
