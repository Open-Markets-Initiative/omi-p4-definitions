...
parser IseoptionsSpreadtradefeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtradefeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreadtradefeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtradefeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtradefeedClientParser(),
    IseoptionsSpreadtradefeedClientVerifyChecksum(),
    IseoptionsSpreadtradefeedClientIngress(),
    IseoptionsSpreadtradefeedClientEgress(),
    IseoptionsSpreadtradefeedClientComputeChecksum(),
    IseoptionsSpreadtradefeedClientDeparser()
) main;
