...
parser IseoptionsSpreadtradefeedTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtradefeedTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsSpreadtradefeedTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtradefeedTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtradefeedTcpParser(),
    IseoptionsSpreadtradefeedTcpVerifyChecksum(),
    IseoptionsSpreadtradefeedTcpIngress(),
    IseoptionsSpreadtradefeedTcpEgress(),
    IseoptionsSpreadtradefeedTcpComputeChecksum(),
    IseoptionsSpreadtradefeedTcpDeparser()
) main;
