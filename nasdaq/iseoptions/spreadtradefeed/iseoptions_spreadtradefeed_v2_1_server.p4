...
control IseoptionsSpreadtradefeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreadtradefeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtradefeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    IseoptionsSpreadtradefeedServerParser(),
    IseoptionsSpreadtradefeedServerVerifyChecksum(),
    IseoptionsSpreadtradefeedServerIngress(),
    IseoptionsSpreadtradefeedServerEgress(),
    IseoptionsSpreadtradefeedServerComputeChecksum(),
    IseoptionsSpreadtradefeedServerDeparser()
) main;
