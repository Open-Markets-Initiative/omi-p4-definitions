...
parser IseoptionsSpreadtradefeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreadtradefeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control IseoptionsSpreadtradefeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreadtradefeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreadtradefeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreadtradefeedServertcpParser(),
    IseoptionsSpreadtradefeedServertcpVerifyChecksum(),
    IseoptionsSpreadtradefeedServertcpIngress(),
    IseoptionsSpreadtradefeedServertcpEgress(),
    IseoptionsSpreadtradefeedServertcpComputeChecksum(),
    IseoptionsSpreadtradefeedServertcpDeparser()
) main;
