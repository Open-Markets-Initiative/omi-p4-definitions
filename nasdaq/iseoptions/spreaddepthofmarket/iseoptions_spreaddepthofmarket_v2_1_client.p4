...
parser IseoptionsSpreaddepthofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreaddepthofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreaddepthofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    IseoptionsSpreaddepthofmarketClientParser(),
    IseoptionsSpreaddepthofmarketClientVerifyChecksum(),
    IseoptionsSpreaddepthofmarketClientIngress(),
    IseoptionsSpreaddepthofmarketClientEgress(),
    IseoptionsSpreaddepthofmarketClientComputeChecksum(),
    IseoptionsSpreaddepthofmarketClientDeparser()
) main;
