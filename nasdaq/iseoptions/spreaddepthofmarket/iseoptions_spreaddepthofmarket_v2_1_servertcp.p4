...
parser IseoptionsSpreaddepthofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreaddepthofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreaddepthofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreaddepthofmarketServertcpParser(),
    IseoptionsSpreaddepthofmarketServertcpVerifyChecksum(),
    IseoptionsSpreaddepthofmarketServertcpIngress(),
    IseoptionsSpreaddepthofmarketServertcpEgress(),
    IseoptionsSpreaddepthofmarketServertcpComputeChecksum(),
    IseoptionsSpreaddepthofmarketServertcpDeparser()
) main;
