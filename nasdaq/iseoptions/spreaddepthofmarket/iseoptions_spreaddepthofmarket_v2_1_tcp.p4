...
parser IseoptionsSpreaddepthofmarketTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreaddepthofmarketTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control IseoptionsSpreaddepthofmarketTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreaddepthofmarketTcpParser(),
    IseoptionsSpreaddepthofmarketTcpVerifyChecksum(),
    IseoptionsSpreaddepthofmarketTcpIngress(),
    IseoptionsSpreaddepthofmarketTcpEgress(),
    IseoptionsSpreaddepthofmarketTcpComputeChecksum(),
    IseoptionsSpreaddepthofmarketTcpDeparser()
) main;
