...
parser IseoptionsSpreaddepthofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IseoptionsSpreaddepthofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IseoptionsSpreaddepthofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IseoptionsSpreaddepthofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IseoptionsSpreaddepthofmarketServerParser(),
    IseoptionsSpreaddepthofmarketServerVerifyChecksum(),
    IseoptionsSpreaddepthofmarketServerIngress(),
    IseoptionsSpreaddepthofmarketServerEgress(),
    IseoptionsSpreaddepthofmarketServerComputeChecksum(),
    IseoptionsSpreaddepthofmarketServerDeparser()
) main;
