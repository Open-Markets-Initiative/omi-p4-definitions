...
parser NtxequitiesOrdersParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NtxequitiesOrdersVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxequitiesOrdersIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NtxequitiesOrdersEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NtxequitiesOrdersComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NtxequitiesOrdersDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NtxequitiesOrdersParser(),
    NtxequitiesOrdersVerifyChecksum(),
    NtxequitiesOrdersIngress(),
    NtxequitiesOrdersEgress(),
    NtxequitiesOrdersComputeChecksum(),
    NtxequitiesOrdersDeparser()
) main;
