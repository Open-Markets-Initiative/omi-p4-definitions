// P4_16 (v1model) definition for: Nasdaq PsxEquities Orders Ouch v4.2
// 
// Protocol:
...
parser PsxequitiesOrdersServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PsxequitiesOrdersServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PsxequitiesOrdersServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PsxequitiesOrdersServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PsxequitiesOrdersServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PsxequitiesOrdersServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PsxequitiesOrdersServerParser(),
    PsxequitiesOrdersServerVerifyChecksum(),
    PsxequitiesOrdersServerIngress(),
    PsxequitiesOrdersServerEgress(),
    PsxequitiesOrdersServerComputeChecksum(),
    PsxequitiesOrdersServerDeparser()
) main;
