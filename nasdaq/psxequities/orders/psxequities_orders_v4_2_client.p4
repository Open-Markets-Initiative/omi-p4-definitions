...
parser PsxequitiesOrdersClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PsxequitiesOrdersClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control PsxequitiesOrdersClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PsxequitiesOrdersClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PsxequitiesOrdersClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PsxequitiesOrdersClientParser(),
    PsxequitiesOrdersClientVerifyChecksum(),
    PsxequitiesOrdersClientIngress(),
    PsxequitiesOrdersClientEgress(),
    PsxequitiesOrdersClientComputeChecksum(),
    PsxequitiesOrdersClientDeparser()
) main;
