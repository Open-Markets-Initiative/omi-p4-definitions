...
parser PsxequitiesOrdersParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PsxequitiesOrdersVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PsxequitiesOrdersIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PsxequitiesOrdersEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PsxequitiesOrdersComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PsxequitiesOrdersDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PsxequitiesOrdersParser(),
    PsxequitiesOrdersVerifyChecksum(),
    PsxequitiesOrdersIngress(),
    PsxequitiesOrdersEgress(),
    PsxequitiesOrdersComputeChecksum(),
    PsxequitiesOrdersDeparser()
) main;
