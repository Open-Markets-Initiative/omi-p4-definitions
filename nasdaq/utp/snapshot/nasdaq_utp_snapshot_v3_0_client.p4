...
parser NasdaqUtpSnapshotClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NasdaqUtpSnapshotClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control NasdaqUtpSnapshotClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NasdaqUtpSnapshotClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    NasdaqUtpSnapshotClientParser(),
    NasdaqUtpSnapshotClientVerifyChecksum(),
    NasdaqUtpSnapshotClientIngress(),
    NasdaqUtpSnapshotClientEgress(),
    NasdaqUtpSnapshotClientComputeChecksum(),
    NasdaqUtpSnapshotClientDeparser()
) main;
