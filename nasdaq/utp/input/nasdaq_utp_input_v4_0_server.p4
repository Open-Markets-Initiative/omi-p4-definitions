...
parser NasdaqUtpInputServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NasdaqUtpInputServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NasdaqUtpInputServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NasdaqUtpInputServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NasdaqUtpInputServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NasdaqUtpInputServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NasdaqUtpInputServerParser(),
    NasdaqUtpInputServerVerifyChecksum(),
    NasdaqUtpInputServerIngress(),
    NasdaqUtpInputServerEgress(),
    NasdaqUtpInputServerComputeChecksum(),
    NasdaqUtpInputServerDeparser()
) main;
