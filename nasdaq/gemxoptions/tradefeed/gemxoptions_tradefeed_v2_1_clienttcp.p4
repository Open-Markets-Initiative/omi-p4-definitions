...
parser GemxoptionsTradefeedClienttcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsTradefeedClienttcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control GemxoptionsTradefeedClienttcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsTradefeedClienttcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTradefeedClienttcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsTradefeedClienttcpParser(),
    GemxoptionsTradefeedClienttcpVerifyChecksum(),
    GemxoptionsTradefeedClienttcpIngress(),
    GemxoptionsTradefeedClienttcpEgress(),
    GemxoptionsTradefeedClienttcpComputeChecksum(),
    GemxoptionsTradefeedClienttcpDeparser()
) main;
