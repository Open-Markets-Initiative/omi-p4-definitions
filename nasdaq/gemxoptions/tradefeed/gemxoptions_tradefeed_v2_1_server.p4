...
parser GemxoptionsTradefeedServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsTradefeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTradefeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control GemxoptionsTradefeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsTradefeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTradefeedServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsTradefeedServerParser(),
    GemxoptionsTradefeedServerVerifyChecksum(),
    GemxoptionsTradefeedServerIngress(),
    GemxoptionsTradefeedServerEgress(),
    GemxoptionsTradefeedServerComputeChecksum(),
    GemxoptionsTradefeedServerDeparser()
) main;
