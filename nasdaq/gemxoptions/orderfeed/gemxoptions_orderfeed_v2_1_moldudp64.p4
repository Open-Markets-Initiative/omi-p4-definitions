...
parser GemxoptionsOrderfeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsOrderfeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control GemxoptionsOrderfeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsOrderfeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsOrderfeedMoldudp64Parser(),
    GemxoptionsOrderfeedMoldudp64VerifyChecksum(),
    GemxoptionsOrderfeedMoldudp64Ingress(),
    GemxoptionsOrderfeedMoldudp64Egress(),
    GemxoptionsOrderfeedMoldudp64ComputeChecksum(),
    GemxoptionsOrderfeedMoldudp64Deparser()
) main;
