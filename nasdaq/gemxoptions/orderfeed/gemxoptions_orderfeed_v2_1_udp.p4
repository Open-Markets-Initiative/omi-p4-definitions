...
parser GemxoptionsOrderfeedUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsOrderfeedUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control GemxoptionsOrderfeedUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsOrderfeedUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsOrderfeedUdpParser(),
    GemxoptionsOrderfeedUdpVerifyChecksum(),
    GemxoptionsOrderfeedUdpIngress(),
    GemxoptionsOrderfeedUdpEgress(),
    GemxoptionsOrderfeedUdpComputeChecksum(),
    GemxoptionsOrderfeedUdpDeparser()
) main;
