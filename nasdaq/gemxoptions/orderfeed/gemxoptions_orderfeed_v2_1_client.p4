...
parser GemxoptionsOrderfeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsOrderfeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control GemxoptionsOrderfeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsOrderfeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsOrderfeedClientParser(),
    GemxoptionsOrderfeedClientVerifyChecksum(),
    GemxoptionsOrderfeedClientIngress(),
    GemxoptionsOrderfeedClientEgress(),
    GemxoptionsOrderfeedClientComputeChecksum(),
    GemxoptionsOrderfeedClientDeparser()
) main;
