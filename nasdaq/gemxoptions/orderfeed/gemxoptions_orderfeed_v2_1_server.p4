...
parser GemxoptionsOrderfeedServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsOrderfeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control GemxoptionsOrderfeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsOrderfeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsOrderfeedServerParser(),
    GemxoptionsOrderfeedServerVerifyChecksum(),
    GemxoptionsOrderfeedServerIngress(),
    GemxoptionsOrderfeedServerEgress(),
    GemxoptionsOrderfeedServerComputeChecksum(),
    GemxoptionsOrderfeedServerDeparser()
) main;
