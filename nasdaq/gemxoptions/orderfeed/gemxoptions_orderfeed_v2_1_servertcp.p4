...
parser GemxoptionsOrderfeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsOrderfeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control GemxoptionsOrderfeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsOrderfeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsOrderfeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsOrderfeedServertcpParser(),
    GemxoptionsOrderfeedServertcpVerifyChecksum(),
    GemxoptionsOrderfeedServertcpIngress(),
    GemxoptionsOrderfeedServertcpEgress(),
    GemxoptionsOrderfeedServertcpComputeChecksum(),
    GemxoptionsOrderfeedServertcpDeparser()
) main;
