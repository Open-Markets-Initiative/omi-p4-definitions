...
parser GemxoptionsDepthofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsDepthofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsDepthofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control GemxoptionsDepthofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsDepthofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsDepthofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsDepthofmarketClientParser(),
    GemxoptionsDepthofmarketClientVerifyChecksum(),
    GemxoptionsDepthofmarketClientIngress(),
    GemxoptionsDepthofmarketClientEgress(),
    GemxoptionsDepthofmarketClientComputeChecksum(),
    GemxoptionsDepthofmarketClientDeparser()
) main;
