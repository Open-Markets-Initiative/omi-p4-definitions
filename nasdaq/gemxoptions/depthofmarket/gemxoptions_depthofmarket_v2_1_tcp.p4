...
parser GemxoptionsDepthofmarketTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsDepthofmarketTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsDepthofmarketTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control GemxoptionsDepthofmarketTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsDepthofmarketTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsDepthofmarketTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsDepthofmarketTcpParser(),
    GemxoptionsDepthofmarketTcpVerifyChecksum(),
    GemxoptionsDepthofmarketTcpIngress(),
    GemxoptionsDepthofmarketTcpEgress(),
    GemxoptionsDepthofmarketTcpComputeChecksum(),
    GemxoptionsDepthofmarketTcpDeparser()
) main;
