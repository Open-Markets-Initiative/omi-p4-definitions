...
parser GemxoptionsTopofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsTopofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTopofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control GemxoptionsTopofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsTopofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTopofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsTopofmarketMoldudp64Parser(),
    GemxoptionsTopofmarketMoldudp64VerifyChecksum(),
    GemxoptionsTopofmarketMoldudp64Ingress(),
    GemxoptionsTopofmarketMoldudp64Egress(),
    GemxoptionsTopofmarketMoldudp64ComputeChecksum(),
    GemxoptionsTopofmarketMoldudp64Deparser()
) main;
