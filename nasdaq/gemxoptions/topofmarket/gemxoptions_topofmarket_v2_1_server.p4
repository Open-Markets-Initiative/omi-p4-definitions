...
parser GemxoptionsTopofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control GemxoptionsTopofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTopofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control GemxoptionsTopofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control GemxoptionsTopofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control GemxoptionsTopofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    GemxoptionsTopofmarketServerParser(),
    GemxoptionsTopofmarketServerVerifyChecksum(),
    GemxoptionsTopofmarketServerIngress(),
    GemxoptionsTopofmarketServerEgress(),
    GemxoptionsTopofmarketServerComputeChecksum(),
    GemxoptionsTopofmarketServerDeparser()
) main;
