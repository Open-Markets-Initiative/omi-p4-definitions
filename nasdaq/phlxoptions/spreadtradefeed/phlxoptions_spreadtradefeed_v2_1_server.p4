...
parser PhlxoptionsSpreadtradefeedServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtradefeedServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadtradefeedServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtradefeedServerParser(),
    PhlxoptionsSpreadtradefeedServerVerifyChecksum(),
    PhlxoptionsSpreadtradefeedServerIngress(),
    PhlxoptionsSpreadtradefeedServerEgress(),
    PhlxoptionsSpreadtradefeedServerComputeChecksum(),
    PhlxoptionsSpreadtradefeedServerDeparser()
) main;
