...
parser PhlxoptionsSpreadtradefeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtradefeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsSpreadtradefeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtradefeedMoldudp64Parser(),
    PhlxoptionsSpreadtradefeedMoldudp64VerifyChecksum(),
    PhlxoptionsSpreadtradefeedMoldudp64Ingress(),
    PhlxoptionsSpreadtradefeedMoldudp64Egress(),
    PhlxoptionsSpreadtradefeedMoldudp64ComputeChecksum(),
    PhlxoptionsSpreadtradefeedMoldudp64Deparser()
) main;
