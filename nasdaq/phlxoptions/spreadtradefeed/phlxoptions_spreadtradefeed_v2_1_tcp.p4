...
parser PhlxoptionsSpreadtradefeedTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtradefeedTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsSpreadtradefeedTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtradefeedTcpParser(),
    PhlxoptionsSpreadtradefeedTcpVerifyChecksum(),
    PhlxoptionsSpreadtradefeedTcpIngress(),
    PhlxoptionsSpreadtradefeedTcpEgress(),
    PhlxoptionsSpreadtradefeedTcpComputeChecksum(),
    PhlxoptionsSpreadtradefeedTcpDeparser()
) main;
