...
parser PhlxoptionsSpreadtradefeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtradefeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadtradefeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtradefeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtradefeedClientParser(),
    PhlxoptionsSpreadtradefeedClientVerifyChecksum(),
    PhlxoptionsSpreadtradefeedClientIngress(),
    PhlxoptionsSpreadtradefeedClientEgress(),
    PhlxoptionsSpreadtradefeedClientComputeChecksum(),
    PhlxoptionsSpreadtradefeedClientDeparser()
) main;
