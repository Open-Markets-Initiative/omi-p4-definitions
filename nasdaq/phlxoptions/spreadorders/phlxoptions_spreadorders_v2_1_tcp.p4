...
parser PhlxoptionsSpreadordersTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadordersTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsSpreadordersTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadordersTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadordersTcpParser(),
    PhlxoptionsSpreadordersTcpVerifyChecksum(),
    PhlxoptionsSpreadordersTcpIngress(),
    PhlxoptionsSpreadordersTcpEgress(),
    PhlxoptionsSpreadordersTcpComputeChecksum(),
    PhlxoptionsSpreadordersTcpDeparser()
) main;
