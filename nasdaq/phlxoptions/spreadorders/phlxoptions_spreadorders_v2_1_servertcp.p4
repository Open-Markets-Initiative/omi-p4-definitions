...
parser PhlxoptionsSpreadordersServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadordersServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadordersServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadordersServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadordersServertcpParser(),
    PhlxoptionsSpreadordersServertcpVerifyChecksum(),
    PhlxoptionsSpreadordersServertcpIngress(),
    PhlxoptionsSpreadordersServertcpEgress(),
    PhlxoptionsSpreadordersServertcpComputeChecksum(),
    PhlxoptionsSpreadordersServertcpDeparser()
) main;
