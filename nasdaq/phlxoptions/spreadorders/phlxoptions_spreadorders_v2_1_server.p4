...
parser PhlxoptionsSpreadordersServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadordersServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadordersServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadordersServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadordersServerParser(),
    PhlxoptionsSpreadordersServerVerifyChecksum(),
    PhlxoptionsSpreadordersServerIngress(),
    PhlxoptionsSpreadordersServerEgress(),
    PhlxoptionsSpreadordersServerComputeChecksum(),
    PhlxoptionsSpreadordersServerDeparser()
) main;
