// P4_16 (v1model) definition for: Nasdaq PhlxOptions SpreadOrders Itch v2.1
// 
// Protocol:
//   Organization: National Association of Securities Dealers Automated Quotations (Nasdaq)
//   Protocol: Spread Orders
//   Encoding: Itch
//   Version: 2.1
//   Date: 09/15/2025
...
parser PhlxoptionsSpreadordersMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadordersMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadordersMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadordersMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadordersMoldudp64Parser(),
    PhlxoptionsSpreadordersMoldudp64VerifyChecksum(),
    PhlxoptionsSpreadordersMoldudp64Ingress(),
    PhlxoptionsSpreadordersMoldudp64Egress(),
    PhlxoptionsSpreadordersMoldudp64ComputeChecksum(),
    PhlxoptionsSpreadordersMoldudp64Deparser()
) main;
