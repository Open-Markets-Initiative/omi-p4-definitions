...
parser PhlxoptionsSpreadordersClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadordersClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadordersClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadordersClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadordersClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadordersClientParser(),
    PhlxoptionsSpreadordersClientVerifyChecksum(),
    PhlxoptionsSpreadordersClientIngress(),
    PhlxoptionsSpreadordersClientEgress(),
    PhlxoptionsSpreadordersClientComputeChecksum(),
    PhlxoptionsSpreadordersClientDeparser()
) main;
