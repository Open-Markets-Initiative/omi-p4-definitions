...
parser PhlxoptionsTopofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsTopofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTopofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsTopofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsTopofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTopofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsTopofmarketClientParser(),
    PhlxoptionsTopofmarketClientVerifyChecksum(),
    PhlxoptionsTopofmarketClientIngress(),
    PhlxoptionsTopofmarketClientEgress(),
    PhlxoptionsTopofmarketClientComputeChecksum(),
    PhlxoptionsTopofmarketClientDeparser()
) main;
