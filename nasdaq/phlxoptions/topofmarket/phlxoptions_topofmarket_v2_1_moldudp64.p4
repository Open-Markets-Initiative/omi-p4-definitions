...
parser PhlxoptionsTopofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsTopofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTopofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsTopofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsTopofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTopofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsTopofmarketMoldudp64Parser(),
    PhlxoptionsTopofmarketMoldudp64VerifyChecksum(),
    PhlxoptionsTopofmarketMoldudp64Ingress(),
    PhlxoptionsTopofmarketMoldudp64Egress(),
    PhlxoptionsTopofmarketMoldudp64ComputeChecksum(),
    PhlxoptionsTopofmarketMoldudp64Deparser()
) main;
