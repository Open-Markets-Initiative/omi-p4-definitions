...
parser PhlxoptionsTopofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsTopofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTopofmarketServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsTopofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsTopofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTopofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsTopofmarketServertcpParser(),
    PhlxoptionsTopofmarketServertcpVerifyChecksum(),
    PhlxoptionsTopofmarketServertcpIngress(),
    PhlxoptionsTopofmarketServertcpEgress(),
    PhlxoptionsTopofmarketServertcpComputeChecksum(),
    PhlxoptionsTopofmarketServertcpDeparser()
) main;
