...
parser PhlxoptionsTradefeedClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsTradefeedClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTradefeedClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsTradefeedClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsTradefeedClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTradefeedClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsTradefeedClientParser(),
    PhlxoptionsTradefeedClientVerifyChecksum(),
    PhlxoptionsTradefeedClientIngress(),
    PhlxoptionsTradefeedClientEgress(),
    PhlxoptionsTradefeedClientComputeChecksum(),
    PhlxoptionsTradefeedClientDeparser()
) main;
