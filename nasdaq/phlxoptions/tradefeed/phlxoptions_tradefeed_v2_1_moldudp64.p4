...
parser PhlxoptionsTradefeedMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsTradefeedMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTradefeedMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsTradefeedMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsTradefeedMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTradefeedMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsTradefeedMoldudp64Parser(),
    PhlxoptionsTradefeedMoldudp64VerifyChecksum(),
    PhlxoptionsTradefeedMoldudp64Ingress(),
    PhlxoptionsTradefeedMoldudp64Egress(),
    PhlxoptionsTradefeedMoldudp64ComputeChecksum(),
    PhlxoptionsTradefeedMoldudp64Deparser()
) main;
