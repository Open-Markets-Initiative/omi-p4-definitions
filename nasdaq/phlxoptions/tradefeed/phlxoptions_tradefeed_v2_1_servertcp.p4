...
parser PhlxoptionsTradefeedServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsTradefeedServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTradefeedServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsTradefeedServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsTradefeedServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsTradefeedServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsTradefeedServertcpParser(),
    PhlxoptionsTradefeedServertcpVerifyChecksum(),
    PhlxoptionsTradefeedServertcpIngress(),
    PhlxoptionsTradefeedServertcpEgress(),
    PhlxoptionsTradefeedServertcpComputeChecksum(),
    PhlxoptionsTradefeedServertcpDeparser()
) main;
