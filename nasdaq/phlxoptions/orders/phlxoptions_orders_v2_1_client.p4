...
parser PhlxoptionsOrdersClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsOrdersClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsOrdersClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsOrdersClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsOrdersClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsOrdersClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsOrdersClientParser(),
    PhlxoptionsOrdersClientVerifyChecksum(),
    PhlxoptionsOrdersClientIngress(),
    PhlxoptionsOrdersClientEgress(),
    PhlxoptionsOrdersClientComputeChecksum(),
    PhlxoptionsOrdersClientDeparser()
) main;
