...
parser PhlxoptionsOrdersServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsOrdersServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsOrdersServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsOrdersServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsOrdersServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsOrdersServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsOrdersServertcpParser(),
    PhlxoptionsOrdersServertcpVerifyChecksum(),
    PhlxoptionsOrdersServertcpIngress(),
    PhlxoptionsOrdersServertcpEgress(),
    PhlxoptionsOrdersServertcpComputeChecksum(),
    PhlxoptionsOrdersServertcpDeparser()
) main;
