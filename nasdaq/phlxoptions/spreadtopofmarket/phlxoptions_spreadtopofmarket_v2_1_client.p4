...
parser PhlxoptionsSpreadtopofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtopofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadtopofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtopofmarketClientParser(),
    PhlxoptionsSpreadtopofmarketClientVerifyChecksum(),
    PhlxoptionsSpreadtopofmarketClientIngress(),
    PhlxoptionsSpreadtopofmarketClientEgress(),
    PhlxoptionsSpreadtopofmarketClientComputeChecksum(),
    PhlxoptionsSpreadtopofmarketClientDeparser()
) main;
