...
parser PhlxoptionsSpreadtopofmarketTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtopofmarketTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsSpreadtopofmarketTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtopofmarketTcpParser(),
    PhlxoptionsSpreadtopofmarketTcpVerifyChecksum(),
    PhlxoptionsSpreadtopofmarketTcpIngress(),
    PhlxoptionsSpreadtopofmarketTcpEgress(),
    PhlxoptionsSpreadtopofmarketTcpComputeChecksum(),
    PhlxoptionsSpreadtopofmarketTcpDeparser()
) main;
