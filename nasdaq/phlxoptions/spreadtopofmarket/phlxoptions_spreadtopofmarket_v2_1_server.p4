...
parser PhlxoptionsSpreadtopofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtopofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreadtopofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtopofmarketServerParser(),
    PhlxoptionsSpreadtopofmarketServerVerifyChecksum(),
    PhlxoptionsSpreadtopofmarketServerIngress(),
    PhlxoptionsSpreadtopofmarketServerEgress(),
    PhlxoptionsSpreadtopofmarketServerComputeChecksum(),
    PhlxoptionsSpreadtopofmarketServerDeparser()
) main;
