...
parser PhlxoptionsSpreadtopofmarketParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtopofmarketVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsSpreadtopofmarketEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtopofmarketParser(),
    PhlxoptionsSpreadtopofmarketVerifyChecksum(),
    PhlxoptionsSpreadtopofmarketIngress(),
    PhlxoptionsSpreadtopofmarketEgress(),
    PhlxoptionsSpreadtopofmarketComputeChecksum(),
    PhlxoptionsSpreadtopofmarketDeparser()
) main;
