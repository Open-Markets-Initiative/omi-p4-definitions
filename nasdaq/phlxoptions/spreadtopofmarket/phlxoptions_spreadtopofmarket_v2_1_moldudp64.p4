...
parser PhlxoptionsSpreadtopofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreadtopofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsSpreadtopofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreadtopofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreadtopofmarketMoldudp64Parser(),
    PhlxoptionsSpreadtopofmarketMoldudp64VerifyChecksum(),
    PhlxoptionsSpreadtopofmarketMoldudp64Ingress(),
    PhlxoptionsSpreadtopofmarketMoldudp64Egress(),
    PhlxoptionsSpreadtopofmarketMoldudp64ComputeChecksum(),
    PhlxoptionsSpreadtopofmarketMoldudp64Deparser()
) main;
