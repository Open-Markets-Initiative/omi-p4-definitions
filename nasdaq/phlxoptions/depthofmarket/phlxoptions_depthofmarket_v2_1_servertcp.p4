...
parser PhlxoptionsDepthofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsDepthofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsDepthofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsDepthofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsDepthofmarketServertcpParser(),
    PhlxoptionsDepthofmarketServertcpVerifyChecksum(),
    PhlxoptionsDepthofmarketServertcpIngress(),
    PhlxoptionsDepthofmarketServertcpEgress(),
    PhlxoptionsDepthofmarketServertcpComputeChecksum(),
    PhlxoptionsDepthofmarketServertcpDeparser()
) main;
