// P4_16 (v1model) definition for: Nasdaq PhlxOptions DepthOfMarket Itch v2.1
// 
// Protocol:
...
parser PhlxoptionsDepthofmarketMoldudp64Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsDepthofmarketMoldudp64VerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketMoldudp64Ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsDepthofmarketMoldudp64Egress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsDepthofmarketMoldudp64ComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketMoldudp64Deparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsDepthofmarketMoldudp64Parser(),
    PhlxoptionsDepthofmarketMoldudp64VerifyChecksum(),
    PhlxoptionsDepthofmarketMoldudp64Ingress(),
    PhlxoptionsDepthofmarketMoldudp64Egress(),
    PhlxoptionsDepthofmarketMoldudp64ComputeChecksum(),
    PhlxoptionsDepthofmarketMoldudp64Deparser()
) main;
