...
parser PhlxoptionsDepthofmarketUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsDepthofmarketUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control PhlxoptionsDepthofmarketUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsDepthofmarketUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsDepthofmarketUdpParser(),
    PhlxoptionsDepthofmarketUdpVerifyChecksum(),
    PhlxoptionsDepthofmarketUdpIngress(),
    PhlxoptionsDepthofmarketUdpEgress(),
    PhlxoptionsDepthofmarketUdpComputeChecksum(),
    PhlxoptionsDepthofmarketUdpDeparser()
) main;
