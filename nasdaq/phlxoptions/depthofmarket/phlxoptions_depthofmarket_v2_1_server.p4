...
parser PhlxoptionsDepthofmarketServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsDepthofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsDepthofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsDepthofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsDepthofmarketServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsDepthofmarketServerParser(),
    PhlxoptionsDepthofmarketServerVerifyChecksum(),
    PhlxoptionsDepthofmarketServerIngress(),
    PhlxoptionsDepthofmarketServerEgress(),
    PhlxoptionsDepthofmarketServerComputeChecksum(),
    PhlxoptionsDepthofmarketServerDeparser()
) main;
