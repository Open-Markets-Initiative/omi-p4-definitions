...
parser PhlxoptionsSpreaddepthofmarketClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreaddepthofmarketClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreaddepthofmarketClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreaddepthofmarketClientParser(),
    PhlxoptionsSpreaddepthofmarketClientVerifyChecksum(),
    PhlxoptionsSpreaddepthofmarketClientIngress(),
    PhlxoptionsSpreaddepthofmarketClientEgress(),
    PhlxoptionsSpreaddepthofmarketClientComputeChecksum(),
    PhlxoptionsSpreaddepthofmarketClientDeparser()
) main;
