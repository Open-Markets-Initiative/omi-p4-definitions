...
parser PhlxoptionsSpreaddepthofmarketServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control PhlxoptionsSpreaddepthofmarketServertcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketServertcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreaddepthofmarketServertcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketServertcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    PhlxoptionsSpreaddepthofmarketServertcpParser(),
    PhlxoptionsSpreaddepthofmarketServertcpVerifyChecksum(),
    PhlxoptionsSpreaddepthofmarketServertcpIngress(),
    PhlxoptionsSpreaddepthofmarketServertcpEgress(),
    PhlxoptionsSpreaddepthofmarketServertcpComputeChecksum(),
    PhlxoptionsSpreaddepthofmarketServertcpDeparser()
) main;
