...
control PhlxoptionsSpreaddepthofmarketServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control PhlxoptionsSpreaddepthofmarketServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control PhlxoptionsSpreaddepthofmarketServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    PhlxoptionsSpreaddepthofmarketServerParser(),
    PhlxoptionsSpreaddepthofmarketServerVerifyChecksum(),
    PhlxoptionsSpreaddepthofmarketServerIngress(),
    PhlxoptionsSpreaddepthofmarketServerEgress(),
    PhlxoptionsSpreaddepthofmarketServerComputeChecksum(),
    PhlxoptionsSpreaddepthofmarketServerDeparser()
) main;
