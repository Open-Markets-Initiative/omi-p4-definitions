// P4_16 (v1model) definition for: Nyse ArcaEquities Bqt Xdp v2.4.a
// 
// Protocol:
...
parser ArcaequitiesBqtParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesBqtVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesBqtIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control ArcaequitiesBqtEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesBqtComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesBqtDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesBqtParser(),
    ArcaequitiesBqtVerifyChecksum(),
    ArcaequitiesBqtIngress(),
    ArcaequitiesBqtEgress(),
    ArcaequitiesBqtComputeChecksum(),
    ArcaequitiesBqtDeparser()
) main;
