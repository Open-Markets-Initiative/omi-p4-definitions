// P4_16 (v1model) definition for: Nyse ArcaEquities Bbo Xdp v2.4.c
// 
// Protocol:
...
parser ArcaequitiesBboParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesBboVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control ArcaequitiesBboEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesBboComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesBboDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesBboParser(),
    ArcaequitiesBboVerifyChecksum(),
    ArcaequitiesBboIngress(),
    ArcaequitiesBboEgress(),
    ArcaequitiesBboComputeChecksum(),
    ArcaequitiesBboDeparser()
) main;
