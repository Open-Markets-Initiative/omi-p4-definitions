// P4_16 (v1model) definition for: Nyse ArcaEquities BinaryGateway PillarStream v6.0
// 
// Protocol:
...
parser ArcaequitiesBinarygatewayParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesBinarygatewayVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesBinarygatewayIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control ArcaequitiesBinarygatewayEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesBinarygatewayComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesBinarygatewayDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesBinarygatewayParser(),
    ArcaequitiesBinarygatewayVerifyChecksum(),
    ArcaequitiesBinarygatewayIngress(),
    ArcaequitiesBinarygatewayEgress(),
    ArcaequitiesBinarygatewayComputeChecksum(),
    ArcaequitiesBinarygatewayDeparser()
) main;
