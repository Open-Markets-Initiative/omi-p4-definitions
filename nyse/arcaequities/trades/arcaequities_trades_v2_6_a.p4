// P4_16 (v1model) definition for: Nyse ArcaEquities Trades Pillar v2.6.a
// 
// Protocol:
...
parser ArcaequitiesTradesParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesTradesVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesTradesIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control ArcaequitiesTradesEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesTradesComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesTradesDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesTradesParser(),
    ArcaequitiesTradesVerifyChecksum(),
    ArcaequitiesTradesIngress(),
    ArcaequitiesTradesEgress(),
    ArcaequitiesTradesComputeChecksum(),
    ArcaequitiesTradesDeparser()
) main;
