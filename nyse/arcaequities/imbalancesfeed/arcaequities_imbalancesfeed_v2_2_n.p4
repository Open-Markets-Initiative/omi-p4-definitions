// P4_16 (v1model) definition for: Nyse ArcaEquities ImbalancesFeed Pillar v2.2.n
// 
// Protocol:
...
parser ArcaequitiesImbalancesfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesImbalancesfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesImbalancesfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control ArcaequitiesImbalancesfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesImbalancesfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesImbalancesfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesImbalancesfeedParser(),
    ArcaequitiesImbalancesfeedVerifyChecksum(),
    ArcaequitiesImbalancesfeedIngress(),
    ArcaequitiesImbalancesfeedEgress(),
    ArcaequitiesImbalancesfeedComputeChecksum(),
    ArcaequitiesImbalancesfeedDeparser()
) main;
