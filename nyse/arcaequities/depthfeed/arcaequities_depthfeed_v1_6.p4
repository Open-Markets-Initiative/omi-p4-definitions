// P4_16 (v1model) definition for: Nyse ArcaEquities DepthFeed Pillar v1.6
// 
// Protocol:
...
parser ArcaequitiesDepthfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesDepthfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesDepthfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control ArcaequitiesDepthfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesDepthfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesDepthfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesDepthfeedParser(),
    ArcaequitiesDepthfeedVerifyChecksum(),
    ArcaequitiesDepthfeedIngress(),
    ArcaequitiesDepthfeedEgress(),
    ArcaequitiesDepthfeedComputeChecksum(),
    ArcaequitiesDepthfeedDeparser()
) main;
