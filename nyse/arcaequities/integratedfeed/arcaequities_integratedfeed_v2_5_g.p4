// P4_16 (v1model) definition for: Nyse ArcaEquities IntegratedFeed Pillar v2.5.g
// 
// Protocol:
...
parser ArcaequitiesIntegratedfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control ArcaequitiesIntegratedfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesIntegratedfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control ArcaequitiesIntegratedfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control ArcaequitiesIntegratedfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control ArcaequitiesIntegratedfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    ArcaequitiesIntegratedfeedParser(),
    ArcaequitiesIntegratedfeedVerifyChecksum(),
    ArcaequitiesIntegratedfeedIngress(),
    ArcaequitiesIntegratedfeedEgress(),
    ArcaequitiesIntegratedfeedComputeChecksum(),
    ArcaequitiesIntegratedfeedDeparser()
) main;
