// P4_16 (v1model) definition for: Nyse AmexEquities ImbalancesFeed Pillar v2.2.n
// 
// Protocol:
...
parser AmexequitiesImbalancesfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control AmexequitiesImbalancesfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesImbalancesfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control AmexequitiesImbalancesfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control AmexequitiesImbalancesfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesImbalancesfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    AmexequitiesImbalancesfeedParser(),
    AmexequitiesImbalancesfeedVerifyChecksum(),
    AmexequitiesImbalancesfeedIngress(),
    AmexequitiesImbalancesfeedEgress(),
    AmexequitiesImbalancesfeedComputeChecksum(),
    AmexequitiesImbalancesfeedDeparser()
) main;
