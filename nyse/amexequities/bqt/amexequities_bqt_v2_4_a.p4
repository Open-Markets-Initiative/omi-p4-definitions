// P4_16 (v1model) definition for: Nyse AmexEquities Bqt Xdp v2.4.a
// 
// Protocol:
...
parser AmexequitiesBqtParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control AmexequitiesBqtVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesBqtIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control AmexequitiesBqtEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control AmexequitiesBqtComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesBqtDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    AmexequitiesBqtParser(),
    AmexequitiesBqtVerifyChecksum(),
    AmexequitiesBqtIngress(),
    AmexequitiesBqtEgress(),
    AmexequitiesBqtComputeChecksum(),
    AmexequitiesBqtDeparser()
) main;
