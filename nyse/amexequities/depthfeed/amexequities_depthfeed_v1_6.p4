// P4_16 (v1model) definition for: Nyse AmexEquities DepthFeed Pillar v1.6
// 
// Protocol:
...
parser AmexequitiesDepthfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control AmexequitiesDepthfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesDepthfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control AmexequitiesDepthfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control AmexequitiesDepthfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesDepthfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    AmexequitiesDepthfeedParser(),
    AmexequitiesDepthfeedVerifyChecksum(),
    AmexequitiesDepthfeedIngress(),
    AmexequitiesDepthfeedEgress(),
    AmexequitiesDepthfeedComputeChecksum(),
    AmexequitiesDepthfeedDeparser()
) main;
