// P4_16 (v1model) definition for: Nyse AmexEquities Trades Pillar v2.6.a
// 
// Protocol:
...
parser AmexequitiesTradesParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control AmexequitiesTradesVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesTradesIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control AmexequitiesTradesEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control AmexequitiesTradesComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesTradesDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    AmexequitiesTradesParser(),
    AmexequitiesTradesVerifyChecksum(),
    AmexequitiesTradesIngress(),
    AmexequitiesTradesEgress(),
    AmexequitiesTradesComputeChecksum(),
    AmexequitiesTradesDeparser()
) main;
