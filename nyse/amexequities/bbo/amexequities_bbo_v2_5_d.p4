// P4_16 (v1model) definition for: Nyse AmexEquities Bbo Pillar v2.5.d
// 
// Protocol:
...
parser AmexequitiesBboParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control AmexequitiesBboVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesBboIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control AmexequitiesBboEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control AmexequitiesBboComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control AmexequitiesBboDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    AmexequitiesBboParser(),
    AmexequitiesBboVerifyChecksum(),
    AmexequitiesBboIngress(),
    AmexequitiesBboEgress(),
    AmexequitiesBboComputeChecksum(),
    AmexequitiesBboDeparser()
) main;
