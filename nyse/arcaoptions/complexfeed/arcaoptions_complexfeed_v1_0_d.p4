// P4_16 (v1model) definition for: Nyse ArcaOptions ComplexFeed Pillar v1.0.d
// 
// Protocol:
...
parser ArcaoptionsComplexfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_complex_series_index_mapping_message {
        ...
        meta.dispatched = 1;
        meta.complex_series_index_mapping_message_leg_definition_remaining = hdr.complex_series_index_mapping_message.last.no_of_legs;
