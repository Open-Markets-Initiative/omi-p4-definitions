// P4_16 (v1model) definition for: Nyse NyseEquities BinaryGateway PillarStream v5.17
// 
// Protocol:
...
parser NyseequitiesBinarygatewayParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NyseequitiesBinarygatewayVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control NyseequitiesBinarygatewayEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NyseequitiesBinarygatewayComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NyseequitiesBinarygatewayDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NyseequitiesBinarygatewayParser(),
    NyseequitiesBinarygatewayVerifyChecksum(),
    NyseequitiesBinarygatewayIngress(),
    NyseequitiesBinarygatewayEgress(),
    NyseequitiesBinarygatewayComputeChecksum(),
    NyseequitiesBinarygatewayDeparser()
) main;
