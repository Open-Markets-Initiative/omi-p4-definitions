// P4_16 (v1model) definition for: Nyse NyseEquities Trades Pillar v2.6.a
// 
// Protocol:
...
parser NyseequitiesTradesParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NyseequitiesTradesVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control NyseequitiesTradesEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NyseequitiesTradesComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NyseequitiesTradesDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NyseequitiesTradesParser(),
    NyseequitiesTradesVerifyChecksum(),
    NyseequitiesTradesIngress(),
    NyseequitiesTradesEgress(),
    NyseequitiesTradesComputeChecksum(),
    NyseequitiesTradesDeparser()
) main;
