// P4_16 (v1model) definition for: Nyse NyseEquities OpenBook.Aggregated Xdp v2.1.d
// 
// Protocol:
...
parser NyseequitiesOpenbookaggregatedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NyseequitiesOpenbookaggregatedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NyseequitiesOpenbookaggregatedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NyseequitiesOpenbookaggregatedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NyseequitiesOpenbookaggregatedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NyseequitiesOpenbookaggregatedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NyseequitiesOpenbookaggregatedParser(),
    NyseequitiesOpenbookaggregatedVerifyChecksum(),
    NyseequitiesOpenbookaggregatedIngress(),
    NyseequitiesOpenbookaggregatedEgress(),
    NyseequitiesOpenbookaggregatedComputeChecksum(),
    NyseequitiesOpenbookaggregatedDeparser()
) main;
