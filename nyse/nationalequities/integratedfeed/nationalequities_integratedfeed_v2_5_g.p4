// P4_16 (v1model) definition for: Nyse NationalEquities IntegratedFeed Pillar v2.5.g
// 
// Protocol:
...
control NationalequitiesIntegratedfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NationalequitiesIntegratedfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NationalequitiesIntegratedfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NationalequitiesIntegratedfeedParser(),
    NationalequitiesIntegratedfeedVerifyChecksum(),
    NationalequitiesIntegratedfeedIngress(),
    NationalequitiesIntegratedfeedEgress(),
    NationalequitiesIntegratedfeedComputeChecksum(),
    NationalequitiesIntegratedfeedDeparser()
) main;
