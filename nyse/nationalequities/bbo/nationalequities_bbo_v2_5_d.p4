// P4_16 (v1model) definition for: Nyse NationalEquities Bbo Pillar v2.5.d
// 
// Protocol:
...
parser NationalequitiesBboParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NationalequitiesBboVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NationalequitiesBboIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NationalequitiesBboEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NationalequitiesBboComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NationalequitiesBboDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NationalequitiesBboParser(),
    NationalequitiesBboVerifyChecksum(),
    NationalequitiesBboIngress(),
    NationalequitiesBboEgress(),
    NationalequitiesBboComputeChecksum(),
    NationalequitiesBboDeparser()
) main;
