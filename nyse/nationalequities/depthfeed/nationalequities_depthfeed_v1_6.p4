// P4_16 (v1model) definition for: Nyse NationalEquities DepthFeed Pillar v1.6
// 
// Protocol:
...
control NationalequitiesDepthfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NationalequitiesDepthfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NationalequitiesDepthfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NationalequitiesDepthfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    NationalequitiesDepthfeedParser(),
    NationalequitiesDepthfeedVerifyChecksum(),
    NationalequitiesDepthfeedIngress(),
    NationalequitiesDepthfeedEgress(),
    NationalequitiesDepthfeedComputeChecksum(),
    NationalequitiesDepthfeedDeparser()
) main;
