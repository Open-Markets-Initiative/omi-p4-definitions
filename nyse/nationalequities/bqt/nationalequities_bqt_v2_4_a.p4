// P4_16 (v1model) definition for: Nyse NationalEquities Bqt Xdp v2.4.a
// 
// Protocol:
...
parser NationalequitiesBqtParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.message_type) {
            ...
            16w0x8e00: parse_best_quotes_message;
            ...
            16w0xca00: parse_consolidated_fractional_stock_summary_message;
            16w0xc900: parse_consolidated_fractional_volume_message;
            default: accept;
        }
    }
...
control NationalequitiesBqtVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NationalequitiesBqtIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control NationalequitiesBqtEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NationalequitiesBqtComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NationalequitiesBqtDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NationalequitiesBqtParser(),
    NationalequitiesBqtVerifyChecksum(),
    NationalequitiesBqtIngress(),
    NationalequitiesBqtEgress(),
    NationalequitiesBqtComputeChecksum(),
    NationalequitiesBqtDeparser()
) main;
