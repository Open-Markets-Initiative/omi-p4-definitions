...
parser AmexoptionsBinarygatewayParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.packet_header.seq_msg_type) {
            ...
            16w0x3302: parse_underlying_symbol_reference_data_message;
            16w0x3402: parse_series_reference_data_message;
            ...
            16w0x3308: parse_options_market_maker_symbol_appointment_reference_data_message;
            16w0x2102: parse_session_configuration_acknowledgement_message;
            16w0x6902: parse_order_and_cancel_replace_acknowledgement_message;
            16w0x9402: parse_bulk_quote_acknowledgment_type_294_message;
            16w0x803: parse_bulk_quote_acknowledgment_message;
            16w0x7802: parse_order_single_complex_modify_cancel_request_acknowledgment_and_urout_message;
            16w0x6802: parse_order_priority_update_acknowledgment_message;
            16w0x9502: parse_execution_report_message;
            16w0x9302: parse_trade_bust_correct_message;
            16w0x6702: parse_application_layer_reject_message;
            16w0x3203: parse_risk_control_acknowledgement_message;
            16w0x3303: parse_risk_control_alert_message;
            16w0x5803: parse_complex_series_request_acknowledgement_message;
            default: accept;
        }
    }
