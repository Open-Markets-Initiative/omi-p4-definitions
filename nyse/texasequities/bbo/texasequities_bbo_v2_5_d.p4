// P4_16 (v1model) definition for: Nyse TexasEquities Bbo Pillar v2.5.d
// 
// Protocol:
...
parser TexasequitiesBboParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control TexasequitiesBboVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesBboIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control TexasequitiesBboEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control TexasequitiesBboComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesBboDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    TexasequitiesBboParser(),
    TexasequitiesBboVerifyChecksum(),
    TexasequitiesBboIngress(),
    TexasequitiesBboEgress(),
    TexasequitiesBboComputeChecksum(),
    TexasequitiesBboDeparser()
) main;
