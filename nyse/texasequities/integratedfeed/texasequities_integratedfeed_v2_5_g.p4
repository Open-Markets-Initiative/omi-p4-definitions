// P4_16 (v1model) definition for: Nyse TexasEquities IntegratedFeed Pillar v2.5.g
// 
// Protocol:
...
parser TexasequitiesIntegratedfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control TexasequitiesIntegratedfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesIntegratedfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control TexasequitiesIntegratedfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control TexasequitiesIntegratedfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesIntegratedfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    TexasequitiesIntegratedfeedParser(),
    TexasequitiesIntegratedfeedVerifyChecksum(),
    TexasequitiesIntegratedfeedIngress(),
    TexasequitiesIntegratedfeedEgress(),
    TexasequitiesIntegratedfeedComputeChecksum(),
    TexasequitiesIntegratedfeedDeparser()
) main;
