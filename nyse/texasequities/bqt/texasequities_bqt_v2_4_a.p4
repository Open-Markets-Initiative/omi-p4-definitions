// P4_16 (v1model) definition for: Nyse TexasEquities Bqt Xdp v2.4.a
// 
// Protocol:
...
parser TexasequitiesBqtParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control TexasequitiesBqtVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control TexasequitiesBqtEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control TexasequitiesBqtComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesBqtDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    TexasequitiesBqtParser(),
    TexasequitiesBqtVerifyChecksum(),
    TexasequitiesBqtIngress(),
    TexasequitiesBqtEgress(),
    TexasequitiesBqtComputeChecksum(),
    TexasequitiesBqtDeparser()
) main;
