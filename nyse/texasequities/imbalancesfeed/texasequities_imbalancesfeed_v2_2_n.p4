// P4_16 (v1model) definition for: Nyse TexasEquities ImbalancesFeed Pillar v2.2.n
// 
// Protocol:
...
parser TexasequitiesImbalancesfeedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control TexasequitiesImbalancesfeedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesImbalancesfeedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control TexasequitiesImbalancesfeedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control TexasequitiesImbalancesfeedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control TexasequitiesImbalancesfeedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    TexasequitiesImbalancesfeedParser(),
    TexasequitiesImbalancesfeedVerifyChecksum(),
    TexasequitiesImbalancesfeedIngress(),
    TexasequitiesImbalancesfeedEgress(),
    TexasequitiesImbalancesfeedComputeChecksum(),
    TexasequitiesImbalancesfeedDeparser()
) main;
