...
parser IexoptionsMarketdataParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            16w0x31: parse_underlying_ref_data_message;
            16w0x32: parse_symbol_mapping_message;
            16w0x33: parse_instrument_clear_message;
            16w0x34: parse_trading_status_message;
            16w0x35: parse_options_auction_summary_message;
            16w0x36: parse_options_auction_width_update_message;
            16w0x37: parse_liquidity_event_notification_message;
            16w0x38: parse_liquidity_event_execution_message;
            16w0x39: parse_liquidity_event_cancel_message;
            16w0x100: parse_add_order_non_customer_message;
            16w0x101: parse_add_order_customer_message;
            16w0x102: parse_modify_order_message;
            16w0x103: parse_delete_order_message;
            16w0x104: parse_order_execution_message;
            16w0x105: parse_deep_trade_break_message;
            16w0x200: parse_quote_update_no_customer_interest_message;
            16w0x201: parse_quote_update_customer_interest_message;
            16w0x202: parse_trade_message;
            16w0x203: parse_trade_correction_message;
            16w0x204: parse_tops_trade_break_message;
            16w0x300: parse_heartbeat_message;
            16w0x301: parse_sequenced_packet_message;
            16w0x302: parse_session_shutdown_message;
            16w0x402: parse_retransmission_request_message;
            16w0x403: parse_retransmission_response_message;
            16w0x601: parse_snapshot_header_message;
            default: accept;
        }
    }
