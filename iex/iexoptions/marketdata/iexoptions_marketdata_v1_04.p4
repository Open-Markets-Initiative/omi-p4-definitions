// P4_16 (v1model) definition for: Iex IexOptions MarketData Sbe v1.04
// 
// Protocol:
...
parser IexoptionsMarketdataParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            16w0x100: parse_underlying_ref_data_message;
            16w0x200: parse_symbol_mapping_message;
            16w0x300: parse_instrument_clear_message;
            16w0x400: parse_trading_status_message;
            16w0x500: parse_options_auction_summary_message;
            16w0x600: parse_options_auction_width_update_message;
            16w0x700: parse_liquidity_event_notification_message;
            16w0x800: parse_liquidity_event_execution_message;
            16w0x900: parse_liquidity_event_cancel_message;
            16w0x6400: parse_add_order_non_customer_message;
            16w0x6500: parse_add_order_customer_message;
            16w0x6600: parse_modify_order_message;
            16w0x6700: parse_delete_order_message;
            16w0x6800: parse_order_execution_message;
            16w0x6900: parse_deep_trade_break_message;
            16w0xc800: parse_quote_update_no_customer_interest_message;
            16w0xc900: parse_quote_update_customer_interest_message;
            16w0xca00: parse_trade_message;
            16w0xcb00: parse_trade_correction_message;
            16w0xcc00: parse_tops_trade_break_message;
            16w0x2c01: parse_heartbeat_message;
            16w0x2d01: parse_sequenced_packet_message;
            16w0x2e01: parse_session_shutdown_message;
            16w0x2f01: parse_sequence_number_reset_message;
