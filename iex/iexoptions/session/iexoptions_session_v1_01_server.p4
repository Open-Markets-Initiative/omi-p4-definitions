...
parser IexoptionsSessionServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control IexoptionsSessionServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IexoptionsSessionServerIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control IexoptionsSessionServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control IexoptionsSessionServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control IexoptionsSessionServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    IexoptionsSessionServerParser(),
    IexoptionsSessionServerVerifyChecksum(),
    IexoptionsSessionServerIngress(),
    IexoptionsSessionServerEgress(),
    IexoptionsSessionServerComputeChecksum(),
    IexoptionsSessionServerDeparser()
) main;
