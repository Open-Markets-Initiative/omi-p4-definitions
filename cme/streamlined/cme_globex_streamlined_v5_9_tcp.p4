...
header md_incremental_refresh_ot_c_356_otc_original_group_t {
    bit<8> md_entry_type;
    bit<32> rpt_seq;
    bit<64> md_entry_px_optional;
    bit<64> mantissa;
...
header md_incremental_refresh_trade_blocks_365_trade_blocks_group_t {
    bit<8> md_update_action;
    bit<64> security_id;
    bit<32> rpt_seq;
    bit<64> md_entry_px;
...
header md_incremental_refresh_ot_c_366_otc_group_t {
    bit<8> md_entry_type;
    bit<32> rpt_seq;
    bit<64> md_entry_px;
    bit<64> mantissa;
...
struct metadata_t {
    ...
    bit<8> md_incremental_refresh_ot_c_356_otc_original_group_remaining;
    ...
    bit<8> md_incremental_refresh_trade_blocks_365_trade_blocks_group_remaining;
    bit<8> md_incremental_refresh_ot_c_366_otc_group_remaining;
}
...
struct headers_t {
    ...
    md_incremental_refresh_ot_c_356_otc_original_group_t md_incremental_refresh_ot_c_356_otc_original_group[MAX_MESSAGES];
    ...
    md_incremental_refresh_trade_blocks_365_trade_blocks_group_t md_incremental_refresh_trade_blocks_365_trade_blocks_group[MAX_MESSAGES];
    md_incremental_refresh_ot_c_366_t md_incremental_refresh_ot_c_366;
    md_incremental_refresh_ot_c_366_otc_group_t md_incremental_refresh_ot_c_366_otc_group[MAX_MESSAGES];
}
...
parser CmeGlobexStreamlinedTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_md_incremental_refresh_ot_c_356 {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_ot_c_356_otc_original_group_remaining = hdr.md_incremental_refresh_ot_c_356.num_in_group_8;
        transition select(meta.md_incremental_refresh_ot_c_356_otc_original_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_ot_c_356_otc_original_group;
        }
    }

    state parse_md_incremental_refresh_ot_c_356_otc_original_group {
        packet.extract(hdr.md_incremental_refresh_ot_c_356_otc_original_group.next);
        meta.md_incremental_refresh_ot_c_356_otc_original_group_remaining = meta.md_incremental_refresh_ot_c_356_otc_original_group_remaining - 1;
        transition select(meta.md_incremental_refresh_ot_c_356_otc_original_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_ot_c_356_otc_original_group;
        }
    ...
    state parse_md_incremental_refresh_trade_blocks_365 {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_trade_blocks_365_trade_blocks_group_remaining = hdr.md_incremental_refresh_trade_blocks_365.num_in_group_8;
        transition select(meta.md_incremental_refresh_trade_blocks_365_trade_blocks_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_trade_blocks_365_trade_blocks_group;
        }
    }

    state parse_md_incremental_refresh_trade_blocks_365_trade_blocks_group {
        packet.extract(hdr.md_incremental_refresh_trade_blocks_365_trade_blocks_group.next);
        meta.md_incremental_refresh_trade_blocks_365_trade_blocks_group_remaining = meta.md_incremental_refresh_trade_blocks_365_trade_blocks_group_remaining - 1;
        transition select(meta.md_incremental_refresh_trade_blocks_365_trade_blocks_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_trade_blocks_365_trade_blocks_group;
        }
    ...
    state parse_md_incremental_refresh_ot_c_366 {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_ot_c_366_otc_group_remaining = hdr.md_incremental_refresh_ot_c_366.num_in_group_8;
        transition select(meta.md_incremental_refresh_ot_c_366_otc_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_ot_c_366_otc_group;
        }
    }

    state parse_md_incremental_refresh_ot_c_366_otc_group {
        packet.extract(hdr.md_incremental_refresh_ot_c_366_otc_group.next);
        meta.md_incremental_refresh_ot_c_366_otc_group_remaining = meta.md_incremental_refresh_ot_c_366_otc_group_remaining - 1;
        transition select(meta.md_incremental_refresh_ot_c_366_otc_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_ot_c_366_otc_group;
        }
...
control CmeGlobexStreamlinedTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.md_incremental_refresh_ot_c_356_otc_original_group);
        ...
        packet.emit(hdr.md_incremental_refresh_trade_blocks_365_trade_blocks_group);
        packet.emit(hdr.md_incremental_refresh_ot_c_366);
        packet.emit(hdr.md_incremental_refresh_ot_c_366_otc_group);
    }
}
