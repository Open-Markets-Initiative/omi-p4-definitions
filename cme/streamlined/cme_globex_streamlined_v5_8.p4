...
parser CmeGlobexStreamlinedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w356: parse_md_incremental_refresh_otc;
...
control CmeGlobexStreamlinedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexStreamlinedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control CmeGlobexStreamlinedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control CmeGlobexStreamlinedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexStreamlinedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    CmeGlobexStreamlinedParser(),
    CmeGlobexStreamlinedVerifyChecksum(),
    CmeGlobexStreamlinedIngress(),
    CmeGlobexStreamlinedEgress(),
    CmeGlobexStreamlinedComputeChecksum(),
    CmeGlobexStreamlinedDeparser()
) main;
