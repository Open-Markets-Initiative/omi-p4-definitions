...
parser CmeGlobexMdp3TcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control CmeGlobexMdp3TcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexMdp3TcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control CmeGlobexMdp3TcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control CmeGlobexMdp3TcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexMdp3TcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    CmeGlobexMdp3TcpParser(),
    CmeGlobexMdp3TcpVerifyChecksum(),
    CmeGlobexMdp3TcpIngress(),
    CmeGlobexMdp3TcpEgress(),
    CmeGlobexMdp3TcpComputeChecksum(),
    CmeGlobexMdp3TcpDeparser()
) main;
