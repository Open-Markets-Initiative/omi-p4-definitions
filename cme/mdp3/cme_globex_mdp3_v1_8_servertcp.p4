// P4_16 (v1model) definition for: Cme Globex Mdp3 Sbe v1.8
// 
// Protocol:
...
header md_incremental_refresh_trade_incremental_refresh_trade_group_t {
    bit<64> md_entry_px;
...
struct metadata_t {
    ...
    bit<8> md_incremental_refresh_trade_incremental_refresh_trade_group_remaining;
...
struct headers_t {
    ...
    md_incremental_refresh_trade_incremental_refresh_trade_group_t md_incremental_refresh_trade_incremental_refresh_trade_group[MAX_MESSAGES];
...
parser CmeGlobexMdp3ServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.server_technical_header.template_id) {
            ...
            16w0x2b00: parse_md_incremental_refresh_order_book;
            16w0x2c00: parse_snapshot_full_refresh_order_book;
    ...
    state parse_md_incremental_refresh_trade {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_trade_incremental_refresh_trade_group_remaining = hdr.md_incremental_refresh_trade.num_in_group;
        transition select(meta.md_incremental_refresh_trade_incremental_refresh_trade_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_trade_incremental_refresh_trade_group;
        }
    }

    state parse_md_incremental_refresh_trade_incremental_refresh_trade_group {
        packet.extract(hdr.md_incremental_refresh_trade_incremental_refresh_trade_group.next);
        meta.md_incremental_refresh_trade_incremental_refresh_trade_group_remaining = meta.md_incremental_refresh_trade_incremental_refresh_trade_group_remaining - 1;
        transition select(meta.md_incremental_refresh_trade_incremental_refresh_trade_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_trade_incremental_refresh_trade_group;
        }
...
control CmeGlobexMdp3ServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.md_incremental_refresh_trade_incremental_refresh_trade_group);
