// P4_16 (v1model) definition for: Cme Globex Mdp3 Sbe v1.13
// 
// Protocol:
...
header md_instrument_definition_repo_broken_dates_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header md_instrument_definition_repo_broken_dates_group_t {
    bit<64> broken_date_guid;
    bit<32> broken_date_security_id;
    bit<16> broken_date_start;
    bit<16> broken_date_end;
}
...
header md_instrument_definition_fx_t {
    ...
    bit<64> alt_min_price_increment;
    bit<32> alt_min_quote_life;
    bit<64> alt_price_increment_constraint;
    bit<64> max_bid_ask_constraint;
    bit<16> block_length;
    bit<8> num_in_group;
}

header md_instrument_definition_fx_events_group_t {
    bit<8> event_type;
    bit<64> event_time;
}

header md_instrument_definition_fx_feed_types_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header md_instrument_definition_fx_feed_types_group_t {
    bit<24> md_feed_type;
    bit<8> market_depth;
}

header md_instrument_definition_fx_inst_attrib_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header md_instrument_definition_fx_inst_attrib_group_t {
    bit<1> electronic_match_eligible;
    bit<1> order_cross_eligible;
    bit<1> block_trade_eligible;
    bit<1> efp_eligible;
...
header md_instrument_definition_fx_fx_lot_type_rules_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header md_instrument_definition_fx_fx_lot_type_rules_group_t {
    bit<8> lot_type;
    bit<64> min_lot_size_u_int_64;
}

header md_instrument_definition_fx_trading_sessions_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header md_instrument_definition_fx_trading_sessions_group_t {
    bit<16> trade_date;
    bit<16> settl_date;
    bit<16> maturity_date;
    bit<96> security_alt_id;
...
header md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_t {
    bit<64> md_entry_px_optional_ex;
...
header md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_header_t {
    bit<16> block_length;
    bit<40> padding_5;
    bit<8> num_in_group;
}

header md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_t {
    bit<64> order_id;
    bit<64> md_order_priority_optional;
    bit<32> md_display_qty_optional;
    bit<8> reference_id;
...
header md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_t {
    bit<64> md_entry_px_ex;
...
header md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_header_t {
    bit<16> block_length;
    bit<40> padding_5;
    bit<8> num_in_group;
}

header md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_t {
    bit<64> order_id;
    bit<32> last_qty;
    bit<32> padding_4;
}
...
header md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_t {
    bit<64> md_entry_size;
    bit<32> security_id;
    bit<32> rpt_seq;
    bit<8> md_update_action;
...
header md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_t {
    bit<64> md_entry_px_ex;
    bit<64> md_entry_size_optional;
    bit<32> security_id;
    bit<32> rpt_seq;
...
header snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_t {
    bit<64> md_entry_px_optional_ex;
    bit<64> md_entry_size_optional;
    bit<32> number_of_orders_optional;
...
header snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_t {
    bit<64> md_entry_px_optional_ex;
    bit<64> md_entry_size_optional;
    bit<32> number_of_orders_optional;
    bit<8> md_price_level_unsigned_optional;
...
struct metadata_t {
    ...
    bit<8> md_instrument_definition_repo_broken_dates_group_remaining;
    ...
    bit<8> md_instrument_definition_fx_events_group_remaining;
    bit<8> md_instrument_definition_fx_feed_types_group_remaining;
    bit<8> md_instrument_definition_fx_inst_attrib_group_remaining;
    bit<8> md_instrument_definition_fx_fx_lot_type_rules_group_remaining;
    bit<8> md_instrument_definition_fx_trading_sessions_group_remaining;
    bit<8> md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_remaining;
    bit<8> md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_remaining;
    bit<8> md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_remaining;
    bit<8> md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_remaining;
    bit<8> md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_remaining;
    bit<8> md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_remaining;
    bit<8> snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_remaining;
    bit<8> snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_remaining;
...
struct headers_t {
    ...
    md_instrument_definition_repo_broken_dates_group_header_t md_instrument_definition_repo_broken_dates_group_header;
    md_instrument_definition_repo_broken_dates_group_t md_instrument_definition_repo_broken_dates_group[MAX_MESSAGES];
    ...
    md_instrument_definition_fx_events_group_t md_instrument_definition_fx_events_group[MAX_MESSAGES];
    md_instrument_definition_fx_feed_types_group_header_t md_instrument_definition_fx_feed_types_group_header;
    md_instrument_definition_fx_feed_types_group_t md_instrument_definition_fx_feed_types_group[MAX_MESSAGES];
    md_instrument_definition_fx_inst_attrib_group_header_t md_instrument_definition_fx_inst_attrib_group_header;
    md_instrument_definition_fx_inst_attrib_group_t md_instrument_definition_fx_inst_attrib_group[MAX_MESSAGES];
    md_instrument_definition_fx_fx_lot_type_rules_group_header_t md_instrument_definition_fx_fx_lot_type_rules_group_header;
    md_instrument_definition_fx_fx_lot_type_rules_group_t md_instrument_definition_fx_fx_lot_type_rules_group[MAX_MESSAGES];
    md_instrument_definition_fx_trading_sessions_group_header_t md_instrument_definition_fx_trading_sessions_group_header;
    md_instrument_definition_fx_trading_sessions_group_t md_instrument_definition_fx_trading_sessions_group[MAX_MESSAGES];
    md_incremental_refresh_book_long_qty_t md_incremental_refresh_book_long_qty;
    md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_t md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group[MAX_MESSAGES];
    md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_header_t md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_header;
    md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_t md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group[MAX_MESSAGES];
    md_incremental_refresh_trade_summary_long_qty_t md_incremental_refresh_trade_summary_long_qty;
    md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_t md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group[MAX_MESSAGES];
    md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_header_t md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_header;
    md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_t md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group[MAX_MESSAGES];
    md_incremental_refresh_volume_long_qty_t md_incremental_refresh_volume_long_qty;
    md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_t md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group[MAX_MESSAGES];
    md_incremental_refresh_session_statistics_long_qty_t md_incremental_refresh_session_statistics_long_qty;
    md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_t md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group[MAX_MESSAGES];
    snapshot_full_refresh_tcp_long_qty_t snapshot_full_refresh_tcp_long_qty;
    snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_t snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group[MAX_MESSAGES];
    snapshot_full_refresh_long_qty_t snapshot_full_refresh_long_qty;
    snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_t snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group[MAX_MESSAGES];
...
parser CmeGlobexMdp3ServertcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.server_technical_header.template_id) {
            ...
            16w0x3e00: parse_collateral_market_value;
            16w0x3f00: parse_md_instrument_definition_fx;
            16w0x4000: parse_md_incremental_refresh_book_long_qty;
            16w0x4100: parse_md_incremental_refresh_trade_summary_long_qty;
            16w0x4200: parse_md_incremental_refresh_volume_long_qty;
            16w0x4300: parse_md_incremental_refresh_session_statistics_long_qty;
            16w0x4400: parse_snapshot_full_refresh_tcp_long_qty;
            16w0x4500: parse_snapshot_full_refresh_long_qty;
    ...
    state read_md_instrument_definition_repo_repo_related_instruments_group {
        ...
        transition select(meta.md_instrument_definition_repo_repo_related_instruments_group_remaining) {
            8w0: read_md_instrument_definition_repo_broken_dates_group;
    ...
    state read_md_instrument_definition_repo_broken_dates_group {
        packet.extract(hdr.md_instrument_definition_repo_broken_dates_group_header);
        meta.md_instrument_definition_repo_broken_dates_group_remaining = hdr.md_instrument_definition_repo_broken_dates_group_header.num_in_group;
        transition select(meta.md_instrument_definition_repo_broken_dates_group_remaining) {
            8w0: accept;
            default: parse_md_instrument_definition_repo_broken_dates_group;
        }
    }

    state parse_md_instrument_definition_repo_broken_dates_group {
        packet.extract(hdr.md_instrument_definition_repo_broken_dates_group.next);
        meta.md_instrument_definition_repo_broken_dates_group_remaining = meta.md_instrument_definition_repo_broken_dates_group_remaining - 1;
        transition select(meta.md_instrument_definition_repo_broken_dates_group_remaining) {
            8w0: accept;
            default: parse_md_instrument_definition_repo_broken_dates_group;
        }
    ...
    state parse_md_instrument_definition_fx {
        ...
        meta.dispatched = 1;
        meta.md_instrument_definition_fx_events_group_remaining = hdr.md_instrument_definition_fx.num_in_group;
        transition select(meta.md_instrument_definition_fx_events_group_remaining) {
            8w0: read_md_instrument_definition_fx_feed_types_group;
            default: parse_md_instrument_definition_fx_events_group;
        }
    }

    state parse_md_instrument_definition_fx_events_group {
        packet.extract(hdr.md_instrument_definition_fx_events_group.next);
        meta.md_instrument_definition_fx_events_group_remaining = meta.md_instrument_definition_fx_events_group_remaining - 1;
        transition select(meta.md_instrument_definition_fx_events_group_remaining) {
            8w0: read_md_instrument_definition_fx_feed_types_group;
            default: parse_md_instrument_definition_fx_events_group;
        }
    ...
    state read_md_instrument_definition_fx_feed_types_group {
        packet.extract(hdr.md_instrument_definition_fx_feed_types_group_header);
        meta.md_instrument_definition_fx_feed_types_group_remaining = hdr.md_instrument_definition_fx_feed_types_group_header.num_in_group;
        transition select(meta.md_instrument_definition_fx_feed_types_group_remaining) {
            8w0: read_md_instrument_definition_fx_inst_attrib_group;
            default: parse_md_instrument_definition_fx_feed_types_group;
        }
    }

    state parse_md_instrument_definition_fx_feed_types_group {
        packet.extract(hdr.md_instrument_definition_fx_feed_types_group.next);
        meta.md_instrument_definition_fx_feed_types_group_remaining = meta.md_instrument_definition_fx_feed_types_group_remaining - 1;
        transition select(meta.md_instrument_definition_fx_feed_types_group_remaining) {
            8w0: read_md_instrument_definition_fx_inst_attrib_group;
            default: parse_md_instrument_definition_fx_feed_types_group;
        }
    ...
    state read_md_instrument_definition_fx_inst_attrib_group {
        packet.extract(hdr.md_instrument_definition_fx_inst_attrib_group_header);
        meta.md_instrument_definition_fx_inst_attrib_group_remaining = hdr.md_instrument_definition_fx_inst_attrib_group_header.num_in_group;
        transition select(meta.md_instrument_definition_fx_inst_attrib_group_remaining) {
            8w0: read_md_instrument_definition_fx_fx_lot_type_rules_group;
            default: parse_md_instrument_definition_fx_inst_attrib_group;
        }
    }

    state parse_md_instrument_definition_fx_inst_attrib_group {
        packet.extract(hdr.md_instrument_definition_fx_inst_attrib_group.next);
        meta.md_instrument_definition_fx_inst_attrib_group_remaining = meta.md_instrument_definition_fx_inst_attrib_group_remaining - 1;
        transition select(meta.md_instrument_definition_fx_inst_attrib_group_remaining) {
            8w0: read_md_instrument_definition_fx_fx_lot_type_rules_group;
            default: parse_md_instrument_definition_fx_inst_attrib_group;
        }
    ...
    state read_md_instrument_definition_fx_fx_lot_type_rules_group {
        packet.extract(hdr.md_instrument_definition_fx_fx_lot_type_rules_group_header);
        meta.md_instrument_definition_fx_fx_lot_type_rules_group_remaining = hdr.md_instrument_definition_fx_fx_lot_type_rules_group_header.num_in_group;
        transition select(meta.md_instrument_definition_fx_fx_lot_type_rules_group_remaining) {
            8w0: read_md_instrument_definition_fx_trading_sessions_group;
            default: parse_md_instrument_definition_fx_fx_lot_type_rules_group;
        }
    }

    state parse_md_instrument_definition_fx_fx_lot_type_rules_group {
        packet.extract(hdr.md_instrument_definition_fx_fx_lot_type_rules_group.next);
        meta.md_instrument_definition_fx_fx_lot_type_rules_group_remaining = meta.md_instrument_definition_fx_fx_lot_type_rules_group_remaining - 1;
        transition select(meta.md_instrument_definition_fx_fx_lot_type_rules_group_remaining) {
            8w0: read_md_instrument_definition_fx_trading_sessions_group;
            default: parse_md_instrument_definition_fx_fx_lot_type_rules_group;
        }
    ...
    state read_md_instrument_definition_fx_trading_sessions_group {
        packet.extract(hdr.md_instrument_definition_fx_trading_sessions_group_header);
        meta.md_instrument_definition_fx_trading_sessions_group_remaining = hdr.md_instrument_definition_fx_trading_sessions_group_header.num_in_group;
        transition select(meta.md_instrument_definition_fx_trading_sessions_group_remaining) {
            8w0: accept;
            default: parse_md_instrument_definition_fx_trading_sessions_group;
        }
    }

    state parse_md_instrument_definition_fx_trading_sessions_group {
        packet.extract(hdr.md_instrument_definition_fx_trading_sessions_group.next);
        meta.md_instrument_definition_fx_trading_sessions_group_remaining = meta.md_instrument_definition_fx_trading_sessions_group_remaining - 1;
        transition select(meta.md_instrument_definition_fx_trading_sessions_group_remaining) {
            8w0: accept;
            default: parse_md_instrument_definition_fx_trading_sessions_group;
        }
    ...
    state parse_md_incremental_refresh_book_long_qty {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_remaining = hdr.md_incremental_refresh_book_long_qty.num_in_group;
        transition select(meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_remaining) {
            8w0: read_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group;
            default: parse_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group;
        }
    }

    state parse_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group {
        packet.extract(hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group.next);
        meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_remaining = meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_remaining - 1;
        transition select(meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group_remaining) {
            8w0: read_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group;
            default: parse_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group;
        }
    ...
    state read_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group {
        packet.extract(hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_header);
        meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_remaining = hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_header.num_in_group;
        transition select(meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group;
        }
    }

    state parse_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group {
        packet.extract(hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group.next);
        meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_remaining = meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_remaining - 1;
        transition select(meta.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group;
        }
    ...
    state parse_md_incremental_refresh_trade_summary_long_qty {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_remaining = hdr.md_incremental_refresh_trade_summary_long_qty.num_in_group;
        transition select(meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_remaining) {
            8w0: read_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group;
            default: parse_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group;
        }
    }

    state parse_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group {
        packet.extract(hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group.next);
        meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_remaining = meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_remaining - 1;
        transition select(meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group_remaining) {
            8w0: read_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group;
            default: parse_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group;
        }
    ...
    state read_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group {
        packet.extract(hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_header);
        meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_remaining = hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_header.num_in_group;
        transition select(meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group;
        }
    }

    state parse_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group {
        packet.extract(hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group.next);
        meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_remaining = meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_remaining - 1;
        transition select(meta.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group;
        }
    ...
    state parse_md_incremental_refresh_volume_long_qty {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_remaining = hdr.md_incremental_refresh_volume_long_qty.num_in_group;
        transition select(meta.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group;
        }
    }

    state parse_md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group {
        packet.extract(hdr.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group.next);
        meta.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_remaining = meta.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_remaining - 1;
        transition select(meta.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group;
        }
    ...
    state parse_md_incremental_refresh_session_statistics_long_qty {
        ...
        meta.dispatched = 1;
        meta.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_remaining = hdr.md_incremental_refresh_session_statistics_long_qty.num_in_group;
        transition select(meta.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group;
        }
    }

    state parse_md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group {
        packet.extract(hdr.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group.next);
        meta.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_remaining = meta.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_remaining - 1;
        transition select(meta.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group_remaining) {
            8w0: accept;
            default: parse_md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group;
        }
    ...
    state parse_snapshot_full_refresh_tcp_long_qty {
        ...
        meta.dispatched = 1;
        meta.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_remaining = hdr.snapshot_full_refresh_tcp_long_qty.num_in_group;
        transition select(meta.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_remaining) {
            8w0: accept;
            default: parse_snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group;
        }
    }

    state parse_snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group {
        packet.extract(hdr.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group.next);
        meta.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_remaining = meta.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_remaining - 1;
        transition select(meta.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group_remaining) {
            8w0: accept;
            default: parse_snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group;
        }
    ...
    state parse_snapshot_full_refresh_long_qty {
        ...
        meta.dispatched = 1;
        meta.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_remaining = hdr.snapshot_full_refresh_long_qty.num_in_group;
        transition select(meta.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_remaining) {
            8w0: accept;
            default: parse_snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group;
        }
    }

    state parse_snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group {
        packet.extract(hdr.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group.next);
        meta.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_remaining = meta.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_remaining - 1;
        transition select(meta.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group_remaining) {
            8w0: accept;
            default: parse_snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group;
        }
...
control CmeGlobexMdp3ServertcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.md_instrument_definition_repo_broken_dates_group_header);
        packet.emit(hdr.md_instrument_definition_repo_broken_dates_group);
        ...
        packet.emit(hdr.md_instrument_definition_fx_events_group);
        packet.emit(hdr.md_instrument_definition_fx_feed_types_group_header);
        packet.emit(hdr.md_instrument_definition_fx_feed_types_group);
        packet.emit(hdr.md_instrument_definition_fx_inst_attrib_group_header);
        packet.emit(hdr.md_instrument_definition_fx_inst_attrib_group);
        packet.emit(hdr.md_instrument_definition_fx_fx_lot_type_rules_group_header);
        packet.emit(hdr.md_instrument_definition_fx_fx_lot_type_rules_group);
        packet.emit(hdr.md_instrument_definition_fx_trading_sessions_group_header);
        packet.emit(hdr.md_instrument_definition_fx_trading_sessions_group);
        packet.emit(hdr.md_incremental_refresh_book_long_qty);
        packet.emit(hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_group);
        packet.emit(hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group_header);
        packet.emit(hdr.md_incremental_refresh_book_long_qty_incremental_refresh_book_long_order_id_group);
        packet.emit(hdr.md_incremental_refresh_trade_summary_long_qty);
        packet.emit(hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_group);
        packet.emit(hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group_header);
        packet.emit(hdr.md_incremental_refresh_trade_summary_long_qty_incremental_refresh_trade_summary_long_order_id_group);
        packet.emit(hdr.md_incremental_refresh_volume_long_qty);
        packet.emit(hdr.md_incremental_refresh_volume_long_qty_incremental_refresh_volume_long_group);
        packet.emit(hdr.md_incremental_refresh_session_statistics_long_qty);
        packet.emit(hdr.md_incremental_refresh_session_statistics_long_qty_incremental_refresh_session_statistics_long_group);
        packet.emit(hdr.snapshot_full_refresh_tcp_long_qty);
        packet.emit(hdr.snapshot_full_refresh_tcp_long_qty_snapshotfull_refresh_tcp_long_group);
        packet.emit(hdr.snapshot_full_refresh_long_qty);
        packet.emit(hdr.snapshot_full_refresh_long_qty_snapshot_full_refresh_long_group);
