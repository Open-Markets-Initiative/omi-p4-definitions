...
parser CmeGlobexDerivedTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control CmeGlobexDerivedTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control CmeGlobexDerivedTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control CmeGlobexDerivedTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexDerivedTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    CmeGlobexDerivedTcpParser(),
    CmeGlobexDerivedTcpVerifyChecksum(),
    CmeGlobexDerivedTcpIngress(),
    CmeGlobexDerivedTcpEgress(),
    CmeGlobexDerivedTcpComputeChecksum(),
    CmeGlobexDerivedTcpDeparser()
) main;
