...
parser CmeGlobexDerivedParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control CmeGlobexDerivedVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexDerivedIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control CmeGlobexDerivedEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control CmeGlobexDerivedComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexDerivedDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    CmeGlobexDerivedParser(),
    CmeGlobexDerivedVerifyChecksum(),
    CmeGlobexDerivedIngress(),
    CmeGlobexDerivedEgress(),
    CmeGlobexDerivedComputeChecksum(),
    CmeGlobexDerivedDeparser()
) main;
