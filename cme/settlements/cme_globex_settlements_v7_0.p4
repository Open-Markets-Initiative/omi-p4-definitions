...
parser CmeGlobexSettlementsParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control CmeGlobexSettlementsVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexSettlementsIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control CmeGlobexSettlementsEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control CmeGlobexSettlementsComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexSettlementsDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    CmeGlobexSettlementsParser(),
    CmeGlobexSettlementsVerifyChecksum(),
    CmeGlobexSettlementsIngress(),
    CmeGlobexSettlementsEgress(),
    CmeGlobexSettlementsComputeChecksum(),
    CmeGlobexSettlementsDeparser()
) main;
