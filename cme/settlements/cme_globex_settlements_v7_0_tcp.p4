...
control CmeGlobexSettlementsTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control CmeGlobexSettlementsTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
        standard_metadata.egress_spec = FORWARD_PORT;
    }
}

control CmeGlobexSettlementsTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control CmeGlobexSettlementsTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    CmeGlobexSettlementsTcpParser(),
    CmeGlobexSettlementsTcpVerifyChecksum(),
    CmeGlobexSettlementsTcpIngress(),
    CmeGlobexSettlementsTcpEgress(),
    CmeGlobexSettlementsTcpComputeChecksum(),
    CmeGlobexSettlementsTcpDeparser()
) main;
