...
header security_definition_request_broken_dates_request_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header security_definition_request_broken_dates_request_group_t {
...
struct metadata_t {
    ...
    bit<8> security_definition_request_broken_dates_request_group_remaining;
}
...
struct headers_t {
    ...
    security_definition_request_broken_dates_request_group_header_t security_definition_request_broken_dates_request_group_header;
    security_definition_request_broken_dates_request_group_t security_definition_request_broken_dates_request_group[MAX_MESSAGES];
}
...
parser CmeGlobexIlink3ClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_security_definition_request {
        ...
        transition select(meta.security_definition_request_request_legs_group_remaining) {
            8w0: read_security_definition_request_broken_dates_request_group;
    ...
    state read_security_definition_request_broken_dates_request_group {
        packet.extract(hdr.security_definition_request_broken_dates_request_group_header);
        meta.security_definition_request_broken_dates_request_group_remaining = hdr.security_definition_request_broken_dates_request_group_header.num_in_group;
        transition select(meta.security_definition_request_broken_dates_request_group_remaining) {
            8w0: accept;
            default: parse_security_definition_request_broken_dates_request_group;
        }
    }

    state parse_security_definition_request_broken_dates_request_group {
        packet.extract(hdr.security_definition_request_broken_dates_request_group.next);
        meta.security_definition_request_broken_dates_request_group_remaining = meta.security_definition_request_broken_dates_request_group_remaining - 1;
        transition select(meta.security_definition_request_broken_dates_request_group_remaining) {
            8w0: accept;
            default: parse_security_definition_request_broken_dates_request_group;
        }
...
control CmeGlobexIlink3ClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.security_definition_request_broken_dates_request_group_header);
        packet.emit(hdr.security_definition_request_broken_dates_request_group);
    }
}
