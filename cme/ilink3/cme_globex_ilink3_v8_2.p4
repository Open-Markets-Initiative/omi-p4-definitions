// P4_16 (v1model) definition for: Cme Globex iLink3 Sbe v8.2
// 
// Protocol:
...
header party_details_definition_request_t {
    ...
    bit<2048> padding_272_chunk0;
    bit<128> padding_272_chunk1;
    bit<16> block_length;
    bit<8> num_in_group;
...
parser CmeGlobexIlink3Parser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w558: parse_order_mass_action_report;
