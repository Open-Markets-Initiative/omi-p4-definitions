// P4_16 (v1model) definition for: Cme Globex iLink3 Sbe v8.9
// 
// Protocol:
...
header execution_report_new_t {
    ...
    bit<8> poss_retrans_flag;
    bit<8> split_msg;
    bit<8> cross_type_optional;
    bit<1> exec_inst_reserved_5;
    bit<1> exec_inst_reserved_4;
    bit<1> exec_inst_reserved_3;
    bit<1> exec_inst_reserved_2;
    bit<1> exec_inst_reserved_1;
    bit<1> nh;
    bit<1> ob;
    bit<1> aon;
    ...
    bit<64> reservation_price;
    bit<8> priority_indicator;
}
...
header mass_quote_ack_t {
    ...
    bit<8> poss_retrans_flag;
    bit<64> delay_to_time;
    bit<8> quote_entry_open;
    bit<8> quote_entry_control;
    bit<16> block_length;
    bit<8> num_in_group;
}
...
header security_definition_response_broken_dates_response_group_header_t {
    bit<16> block_length;
    bit<8> num_in_group;
}

header security_definition_response_broken_dates_response_group_t {
...
header quote_cancel_ack_t {
    ...
    bit<32> no_processed_entries_32;
    bit<8> mm_protection_reset;
...
header execution_report_pending_cancel_t {
    bit<32> seq_num;
    bit<64> uuid;
    bit<320> exec_id;
    bit<160> sender_id;
...
header execution_report_pending_replace_t {
    bit<32> seq_num;
    bit<64> uuid;
    bit<320> exec_id;
    bit<160> sender_id;
...
header mass_quote_response_mass_quote_response_entries_group_t {
    bit<64> order_id_optional;
    bit<32> quote_entry_id;
    bit<16> quote_set_id;
    bit<32> security_id;
    bit<8> side_side;
    bit<8> quote_entry_reject_reason_optional;
}
...
struct metadata_t {
    ...
    bit<8> security_definition_response_broken_dates_response_group_remaining;
    ...
    bit<8> mass_quote_response_mass_quote_response_entries_group_remaining;
}
...
struct headers_t {
    ...
    security_definition_response_broken_dates_response_group_header_t security_definition_response_broken_dates_response_group_header;
    security_definition_response_broken_dates_response_group_t security_definition_response_broken_dates_response_group[MAX_MESSAGES];
    ...
    execution_report_pending_cancel_t execution_report_pending_cancel;
    execution_report_pending_replace_t execution_report_pending_replace;
    mass_quote_response_t mass_quote_response;
    mass_quote_response_mass_quote_response_entries_group_t mass_quote_response_mass_quote_response_entries_group[MAX_MESSAGES];
}
...
parser CmeGlobexIlink3ServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0x3202: parse_order_mass_action_report;
            16w0x3302: parse_quote_cancel_ack;
            16w0x3402: parse_execution_report_pending_cancel;
            16w0x3502: parse_execution_report_pending_replace;
            16w0x3b02: parse_mass_quote_response;
            default: accept;
        }
    }
    ...
    state parse_security_definition_response {
        ...
        transition select(meta.security_definition_response_response_legs_group_remaining) {
            8w0: read_security_definition_response_broken_dates_response_group;
    ...
    state read_security_definition_response_broken_dates_response_group {
        packet.extract(hdr.security_definition_response_broken_dates_response_group_header);
        meta.security_definition_response_broken_dates_response_group_remaining = hdr.security_definition_response_broken_dates_response_group_header.num_in_group;
        transition select(meta.security_definition_response_broken_dates_response_group_remaining) {
            8w0: accept;
            default: parse_security_definition_response_broken_dates_response_group;
        }
    }

    state parse_security_definition_response_broken_dates_response_group {
        packet.extract(hdr.security_definition_response_broken_dates_response_group.next);
        meta.security_definition_response_broken_dates_response_group_remaining = meta.security_definition_response_broken_dates_response_group_remaining - 1;
        transition select(meta.security_definition_response_broken_dates_response_group_remaining) {
            8w0: accept;
            default: parse_security_definition_response_broken_dates_response_group;
        }
    ...
    state parse_execution_report_pending_cancel {
        packet.extract(hdr.execution_report_pending_cancel);
        meta.dispatched = 1;
        transition accept;
    }

    state parse_execution_report_pending_replace {
        packet.extract(hdr.execution_report_pending_replace);
        meta.dispatched = 1;
        transition accept;
    }
    ...
    state parse_mass_quote_response {
        ...
        meta.dispatched = 1;
        meta.mass_quote_response_mass_quote_response_entries_group_remaining = hdr.mass_quote_response.num_in_group;
        transition select(meta.mass_quote_response_mass_quote_response_entries_group_remaining) {
            8w0: accept;
            default: parse_mass_quote_response_mass_quote_response_entries_group;
        }
    }

    state parse_mass_quote_response_mass_quote_response_entries_group {
        packet.extract(hdr.mass_quote_response_mass_quote_response_entries_group.next);
        meta.mass_quote_response_mass_quote_response_entries_group_remaining = meta.mass_quote_response_mass_quote_response_entries_group_remaining - 1;
        transition select(meta.mass_quote_response_mass_quote_response_entries_group_remaining) {
            8w0: accept;
            default: parse_mass_quote_response_mass_quote_response_entries_group;
        }
...
control CmeGlobexIlink3ServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.security_definition_response_broken_dates_response_group_header);
        packet.emit(hdr.security_definition_response_broken_dates_response_group);
        ...
        packet.emit(hdr.execution_report_pending_cancel);
        packet.emit(hdr.execution_report_pending_replace);
        packet.emit(hdr.mass_quote_response);
        packet.emit(hdr.mass_quote_response_mass_quote_response_entries_group);
    }
}
