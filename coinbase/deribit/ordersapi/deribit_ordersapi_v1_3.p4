...
parser DeribitOrdersapiParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.session_flags.template_id) {
            16w0x31: parse_logon_message;
            16w0x32: parse_logon_conf_message;
            16w0x34: parse_logout_message;
            16w0x35: parse_logged_out_message;
            16w0x10: parse_heartbeat_message;
            16w0x11: parse_test_request_message;
            16w0x20: parse_resend_request_message;
            16w0x21: parse_gap_fill_message;
            16w0x30: parse_reject_message;
            16w0x100: parse_new_order_request_message;
            16w0x110: parse_amend_order_request_message;
            16w0x120: parse_cancel_order_request_message;
            16w0x125: parse_cancel_order_by_id_request_message;
            16w0x130: parse_mass_quote_request_message;
            16w0x140: parse_mass_cancel_request_message;
            16w0x145: parse_mass_quote_cancel_request_message;
            16w0x155: parse_get_mass_quote_mmp_status_request_message;
            16w0x156: parse_get_orders_mmp_status_request_message;
            16w0x200: parse_new_order_response_message;
            16w0x202: parse_new_order_reject_message;
            16w0x210: parse_amend_order_response_message;
            16w0x212: parse_amend_order_reject_message;
            16w0x220: parse_cancel_order_response_message;
            16w0x222: parse_cancel_order_reject_message;
            16w0x230: parse_mass_quote_response_message;
            16w0x232: parse_mass_quote_reject_message;
            16w0x240: parse_mass_cancel_response_message;
            16w0x242: parse_mass_cancel_reject_message;
            16w0x280: parse_get_mass_quote_mmp_status_response_message;
            16w0x281: parse_get_mass_quote_mmp_status_reject_message;
            16w0x282: parse_get_orders_mmp_status_response_message;
            16w0x283: parse_get_orders_mmp_status_reject_message;
            16w0x300: parse_order_filled_message;
            16w0x310: parse_orders_canceled_message;
            16w0x312: parse_order_placed_message;
            16w0x314: parse_mass_quote_orders_placed_message;
            16w0x320: parse_mass_quote_mmp_triggered_message;
            16w0x322: parse_orders_mmp_triggered_message;
            16w0x324: parse_mass_quote_mmp_unfrozen_message;
            16w0x326: parse_orders_mmp_unfrozen_message;
            default: accept;
        }
    }
