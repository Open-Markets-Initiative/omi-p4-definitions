// P4_16 (v1model) definition for: Sgx TitanDt DepthOfBook Itch v1.4
// 
// Protocol:
...
struct headers_t {
    ...
    tick_size_table_entry_message_t tick_size_table_entry_message[MAX_MESSAGES];
...
parser SgxTitandtDepthofbookParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control SgxTitandtDepthofbookVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control SgxTitandtDepthofbookIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control SgxTitandtDepthofbookEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control SgxTitandtDepthofbookComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control SgxTitandtDepthofbookDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    SgxTitandtDepthofbookParser(),
    SgxTitandtDepthofbookVerifyChecksum(),
    SgxTitandtDepthofbookIngress(),
    SgxTitandtDepthofbookEgress(),
    SgxTitandtDepthofbookComputeChecksum(),
    SgxTitandtDepthofbookDeparser()
) main;
