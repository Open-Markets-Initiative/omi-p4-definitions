...
parser SgxTitandtDepthofbookClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control SgxTitandtDepthofbookClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control SgxTitandtDepthofbookClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control SgxTitandtDepthofbookClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control SgxTitandtDepthofbookClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control SgxTitandtDepthofbookClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    SgxTitandtDepthofbookClientParser(),
    SgxTitandtDepthofbookClientVerifyChecksum(),
    SgxTitandtDepthofbookClientIngress(),
    SgxTitandtDepthofbookClientEgress(),
    SgxTitandtDepthofbookClientComputeChecksum(),
    SgxTitandtDepthofbookClientDeparser()
) main;
