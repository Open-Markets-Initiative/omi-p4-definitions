...
parser JnxbondsPtsClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control JnxbondsPtsClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control JnxbondsPtsClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control JnxbondsPtsClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control JnxbondsPtsClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    JnxbondsPtsClientParser(),
    JnxbondsPtsClientVerifyChecksum(),
    JnxbondsPtsClientIngress(),
    JnxbondsPtsClientEgress(),
    JnxbondsPtsClientComputeChecksum(),
    JnxbondsPtsClientDeparser()
) main;
