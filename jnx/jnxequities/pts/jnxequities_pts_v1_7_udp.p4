...
parser JnxequitiesPtsUdpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control JnxequitiesPtsUdpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control JnxequitiesPtsUdpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control JnxequitiesPtsUdpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control JnxequitiesPtsUdpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control JnxequitiesPtsUdpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    JnxequitiesPtsUdpParser(),
    JnxequitiesPtsUdpVerifyChecksum(),
    JnxequitiesPtsUdpIngress(),
    JnxequitiesPtsUdpEgress(),
    JnxequitiesPtsUdpComputeChecksum(),
    JnxequitiesPtsUdpDeparser()
) main;
