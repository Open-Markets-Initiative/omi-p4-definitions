// P4_16 (v1model) definition for: B3 B3Derivatives BinaryEntryPoint Sbe v8.4
// 
// Protocol:
...
//   Version: 8.4
//   Date: 12/10/2025
//   Specification: BinaryEntryPoint-MessageReference-8.4.2-enUS.pdf
// 
...
header new_order_cross_message_t {
    ...
    bit<8> market_segment_id;
    bit<8> padding;
    bit<8> ord_type_cross_ord_type_optional;
...
header execution_report_forward_message_t {
    ...
    bit<64> secondary_exec_id;
    bit<64> exec_ref_id;
    bit<64> fixed_rate_percentage_8_optional;
    bit<64> order_qty;
    bit<8> trading_session_id;
    bit<8> trading_session_sub_id;
    bit<8> security_trading_status;
...
header quote_request_message_t {
    ...
    bit<64> fixed_rate_percentage_8;
