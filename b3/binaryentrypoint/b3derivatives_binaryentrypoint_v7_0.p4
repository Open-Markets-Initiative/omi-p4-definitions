// P4_16 (v1model) definition for: B3 B3Derivatives BinaryEntryPoint Sbe v7.0
// 
// Protocol:
...
header simple_new_order_message_t {
    ...
    bit<8> investor_id_length;
    bit<8> investor_id_data;
    bit<8> memo_length;
    bit<8> memo_data;
}
...
header order_mass_action_report_message_comp_ids_group_t {
    bit<32> ref_comp_id;
}
...
struct metadata_t {
    ...
    bit<8> order_mass_action_report_message_comp_ids_group_remaining;
}
...
struct headers_t {
    ...
    order_mass_action_report_message_comp_ids_group_t order_mass_action_report_message_comp_ids_group[MAX_MESSAGES];
}
...
parser B3derivativesBinaryentrypointParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            16w0x100: parse_negotiate_message;
            16w0x200: parse_negotiate_response_message;
            16w0x300: parse_negotiate_reject_message;
            16w0x400: parse_establish_message;
            16w0x500: parse_establish_ack_message;
            16w0x600: parse_establish_reject_message;
            16w0x700: parse_terminate_message;
            16w0x800: parse_not_applied_message;
            16w0x900: parse_sequence_message;
            16w0xc00: parse_retransmit_request_message;
            16w0xd00: parse_retransmission_message;
            16w0xe00: parse_retransmit_reject_message;
            16w0x6400: parse_simple_new_order_message;
            16w0x6500: parse_simple_modify_order_message;
            16w0x6600: parse_new_order_single_message;
            16w0x6800: parse_order_cancel_replace_request_message;
            16w0x6900: parse_order_cancel_request_message;
            16w0x6a00: parse_new_order_cross_message;
            16w0xc800: parse_execution_report_new_message;
            16w0xc900: parse_execution_report_modify_message;
            16w0xca00: parse_execution_report_cancel_message;
            16w0xcb00: parse_execution_report_trade_message;
            16w0xcc00: parse_execution_report_reject_message;
            16w0xcd00: parse_execution_report_forward_message;
            16w0xce00: parse_business_message_reject_message;
            16w0x2c01: parse_security_definition_request_message;
            16w0x2d01: parse_security_definition_response_message;
            16w0x9101: parse_quote_request_message;
            16w0x9201: parse_quote_status_report_message;
            16w0x9301: parse_quote_message;
            16w0x9401: parse_quote_cancel_message;
            16w0x9501: parse_quote_request_reject_message;
            16w0xf501: parse_position_maintenance_cancel_request_message;
            16w0xf601: parse_position_maintenance_request_message;
            16w0xf701: parse_position_maintenance_report_message;
            16w0x5902: parse_allocation_instruction_message;
            16w0x5a02: parse_allocation_report_message;
            16w0xbd02: parse_order_mass_action_request_message;
            16w0xbe02: parse_order_mass_action_report_message;
            default: accept;
        }
    }
    ...
    state parse_order_mass_action_report_message {
        ...
        meta.dispatched = 1;
        meta.order_mass_action_report_message_comp_ids_group_remaining = hdr.order_mass_action_report_message.num_in_group;
        transition select(meta.order_mass_action_report_message_comp_ids_group_remaining) {
            8w0: accept;
            default: parse_order_mass_action_report_message_comp_ids_group;
        }
    }

    state parse_order_mass_action_report_message_comp_ids_group {
        packet.extract(hdr.order_mass_action_report_message_comp_ids_group.next);
        meta.order_mass_action_report_message_comp_ids_group_remaining = meta.order_mass_action_report_message_comp_ids_group_remaining - 1;
        transition select(meta.order_mass_action_report_message_comp_ids_group_remaining) {
            8w0: accept;
            default: parse_order_mass_action_report_message_comp_ids_group;
        }
...
control B3derivativesBinaryentrypointDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.order_mass_action_report_message_comp_ids_group);
    }
}
