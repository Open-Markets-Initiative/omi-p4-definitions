// P4_16 (v1model) definition for: B3 B3Derivatives BinaryUmdf Sbe v1.8
// 
// Protocol:
...
header deprecated_security_definition_message_t {
    ...
    bit<64> min_price_increment_legacy;
    bit<64> strike_price;
...
header price_band_20_message_t {
    ...
    bit<64> trading_reference_price_legacy;
    bit<64> md_entry_timestamp;
    bit<32> rpt_seq;
}
...
header price_band_22_message_t {
    ...
    bit<64> low_limit_price;
    bit<64> high_limit_price;
    bit<64> trading_reference_price_optional;
    bit<64> md_entry_timestamp;
    bit<32> rpt_seq;
}
...
parser B3derivativesBinaryumdfParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0x400: parse_deprecated_security_definition_message;
            ...
            16w0x1400: parse_price_band_20_message;
