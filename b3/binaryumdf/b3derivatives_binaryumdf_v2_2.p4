// P4_16 (v1model) definition for: B3 B3Derivatives BinaryUmdf Sbe v2.2
// 
// Protocol:
...
//   Version: 2.2
//   Date: 7/18/2025
//   Specification: BinaryUMDF-MessageReference-v.2.2.0-enUS.pdf
// 
...
header empty_book_message_t {
    bit<64> security_id;
    bit<1> unused_match_event_indicator_0;
    bit<1> unused_match_event_indicator_1;
    bit<1> unused_match_event_indicator_2;
    bit<1> unused_match_event_indicator_3;
    bit<1> implied;
    bit<1> recovery_msg;
    bit<1> unused_match_event_indicator_6;
    bit<1> end_of_event;
...
struct headers_t {
    ...
    price_band_22_message_t price_band_22_message;
    ...
    settlement_price_28_message_t settlement_price_28_message;
    open_interest_29_message_t open_interest_29_message;
...
parser B3derivativesBinaryumdfParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0xc00: parse_security_definition_message;
            16w0x500: parse_news_5_message;
            16w0xf00: parse_opening_price_15_message;
            16w0x1000: parse_theoretical_opening_price_16_message;
            16w0x1100: parse_closing_price_17_message;
            16w0x1300: parse_auction_imbalance_19_message;
            16w0x1500: parse_quantity_band_21_message;
            16w0x1600: parse_price_band_22_message;
            16w0x1800: parse_high_price_24_message;
            16w0x1900: parse_low_price_25_message;
            16w0x1b00: parse_last_trade_price_27_message;
            16w0x1c00: parse_settlement_price_28_message;
            16w0x1d00: parse_open_interest_29_message;
            16w0x1e00: parse_snapshot_full_refresh_header_30_message;
            16w0x3200: parse_order_mb_o_50_message;
            16w0x3300: parse_delete_order_mb_o_51_message;
            16w0x3400: parse_mass_delete_orders_mb_o_52_message;
            16w0x3500: parse_trade_53_message;
            16w0x3600: parse_forward_trade_54_message;
            16w0x3700: parse_execution_summary_55_message;
            16w0x3800: parse_execution_statistics_56_message;
            16w0x3900: parse_trade_bust_57_message;
...
control B3derivativesBinaryumdfDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.price_band_22_message);
        packet.emit(hdr.high_price_24_message);
        packet.emit(hdr.low_price_25_message);
        packet.emit(hdr.last_trade_price_27_message);
        packet.emit(hdr.settlement_price_28_message);
        packet.emit(hdr.open_interest_29_message);
