...
parser BseindiaEtiClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            16w10390: parse_debt_inquiry_request;
            ...
            16w10991: parse_multi_leg_order_request;
            ...
            16w10997: parse_session_password_change_request;
            16w10053: parse_session_registration_request;
            ...
            16w10996: parse_user_password_change_request;
            default: accept;
        }
    }
