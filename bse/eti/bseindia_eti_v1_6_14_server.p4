...
parser BseindiaEtiServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w10391: parse_debt_inquiry_response;
            ...
            16w10022: parse_gateway_response;
            16w10990: parse_gw_order_acknowledgement;
            ...
            16w10994: parse_multi_leg_exec_report_broadcast;
            16w10993: parse_multi_leg_exec_response;
            16w10992: parse_multi_leg_order_reject;
            ...
            16w10412: parse_quote_exec_report_broadcast;
            ...
            16w10048: parse_risk_collateral_alert_admin_broadcast;
            16w10049: parse_risk_collateral_alert_broadcast;
            16w10033: parse_risk_notification_broadcast;
            16w10030: parse_service_availability_broadcast;
            16w10995: parse_session_password_change_response;
            16w10054: parse_session_registration_response;
            ...
            16w10989: parse_trade_enhancement_broadcast;
            ...
            16w10043: parse_user_password_change_response;
            default: accept;
        }
    }
