...
parser BivaequitiesTotalviewClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control BivaequitiesTotalviewClientVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BivaequitiesTotalviewClientIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control BivaequitiesTotalviewClientEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control BivaequitiesTotalviewClientComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BivaequitiesTotalviewClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    BivaequitiesTotalviewClientParser(),
    BivaequitiesTotalviewClientVerifyChecksum(),
    BivaequitiesTotalviewClientIngress(),
    BivaequitiesTotalviewClientEgress(),
    BivaequitiesTotalviewClientComputeChecksum(),
    BivaequitiesTotalviewClientDeparser()
) main;
