// P4_16 (v1model) definition for: Biva BivaEquities LastSale Itch v1.12
// 
// Protocol:
...
parser BivaequitiesLastsaleParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control BivaequitiesLastsaleVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BivaequitiesLastsaleIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control BivaequitiesLastsaleEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control BivaequitiesLastsaleComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BivaequitiesLastsaleDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    BivaequitiesLastsaleParser(),
    BivaequitiesLastsaleVerifyChecksum(),
    BivaequitiesLastsaleIngress(),
    BivaequitiesLastsaleEgress(),
    BivaequitiesLastsaleComputeChecksum(),
    BivaequitiesLastsaleDeparser()
) main;
