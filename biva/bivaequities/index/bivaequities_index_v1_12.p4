// P4_16 (v1model) definition for: Biva BivaEquities Index Itch v1.12
// 
// Protocol:
...
parser BivaequitiesIndexParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control BivaequitiesIndexVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BivaequitiesIndexIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control BivaequitiesIndexEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control BivaequitiesIndexComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BivaequitiesIndexDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    BivaequitiesIndexParser(),
    BivaequitiesIndexVerifyChecksum(),
    BivaequitiesIndexIngress(),
    BivaequitiesIndexEgress(),
    BivaequitiesIndexComputeChecksum(),
    BivaequitiesIndexDeparser()
) main;
