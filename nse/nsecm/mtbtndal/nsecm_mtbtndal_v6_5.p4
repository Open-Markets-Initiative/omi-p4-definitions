// P4_16 (v1model) definition for: Nse NseCm MtbtNdal Binary v6.5
// 
// Protocol:
...
parser NsecmMtbtndalParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecmMtbtndalVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmMtbtndalIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecmMtbtndalEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecmMtbtndalComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmMtbtndalDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecmMtbtndalParser(),
    NsecmMtbtndalVerifyChecksum(),
    NsecmMtbtndalIngress(),
    NsecmMtbtndalEgress(),
    NsecmMtbtndalComputeChecksum(),
    NsecmMtbtndalDeparser()
) main;
