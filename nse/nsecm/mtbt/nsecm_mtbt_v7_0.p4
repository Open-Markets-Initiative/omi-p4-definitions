// P4_16 (v1model) definition for: Nse NseCm Mtbt Binary v7.0
// 
// Protocol:
...
parser NsecmMtbtParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecmMtbtVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmMtbtIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecmMtbtEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecmMtbtComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmMtbtDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecmMtbtParser(),
    NsecmMtbtVerifyChecksum(),
    NsecmMtbtIngress(),
    NsecmMtbtEgress(),
    NsecmMtbtComputeChecksum(),
    NsecmMtbtDeparser()
) main;
