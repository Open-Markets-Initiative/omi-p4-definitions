// P4_16 (v1model) definition for: Nse NseCm Recovery Binary v7.0
// 
// Protocol:
...
//   Version: 7.0
//   Date: 8/1/2026
//   Specification: MTBT_CM_NNF_PROTOCOL_7.0_20260817172043.pdf
// 
...
parser NsecmRecoveryTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecmRecoveryTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmRecoveryTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecmRecoveryTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecmRecoveryTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmRecoveryTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecmRecoveryTcpParser(),
    NsecmRecoveryTcpVerifyChecksum(),
    NsecmRecoveryTcpIngress(),
    NsecmRecoveryTcpEgress(),
    NsecmRecoveryTcpComputeChecksum(),
    NsecmRecoveryTcpDeparser()
) main;
