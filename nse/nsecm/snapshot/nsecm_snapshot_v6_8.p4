// P4_16 (v1model) definition for: Nse NseCm Snapshot Binary v6.8
// 
// Protocol:
...
parser NsecmSnapshotParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecmSnapshotVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmSnapshotIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecmSnapshotEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecmSnapshotComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecmSnapshotDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecmSnapshotParser(),
    NsecmSnapshotVerifyChecksum(),
    NsecmSnapshotIngress(),
    NsecmSnapshotEgress(),
    NsecmSnapshotComputeChecksum(),
    NsecmSnapshotDeparser()
) main;
