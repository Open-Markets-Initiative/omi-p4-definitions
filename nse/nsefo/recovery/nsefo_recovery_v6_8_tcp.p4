// P4_16 (v1model) definition for: Nse NseFo Recovery Binary v6.8
// 
// Protocol:
...
//   Version: 6.8
//   Date: 12/1/2025
//   Specification: MTBT_FO_NNF_PROTOCOL_6_8_20260401172252.pdf
// 
...
parser NsefoRecoveryTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsefoRecoveryTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsefoRecoveryTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsefoRecoveryTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsefoRecoveryTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsefoRecoveryTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsefoRecoveryTcpParser(),
    NsefoRecoveryTcpVerifyChecksum(),
    NsefoRecoveryTcpIngress(),
    NsefoRecoveryTcpEgress(),
    NsefoRecoveryTcpComputeChecksum(),
    NsefoRecoveryTcpDeparser()
) main;
