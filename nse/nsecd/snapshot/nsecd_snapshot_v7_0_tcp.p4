...
parser NsecdSnapshotTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecdSnapshotTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecdSnapshotTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecdSnapshotTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecdSnapshotTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecdSnapshotTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecdSnapshotTcpParser(),
    NsecdSnapshotTcpVerifyChecksum(),
    NsecdSnapshotTcpIngress(),
    NsecdSnapshotTcpEgress(),
    NsecdSnapshotTcpComputeChecksum(),
    NsecdSnapshotTcpDeparser()
) main;
