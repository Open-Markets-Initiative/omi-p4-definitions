// P4_16 (v1model) definition for: Nse NseCd Recovery Binary v7.0
// 
// Protocol:
...
//   Version: 7.0
//   Date: 8/1/2026
//   Specification: MTBT_CUR_NNF_PROTOCOL_7.0_20260817172132.pdf
// 
...
parser NsecdRecoveryTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecdRecoveryTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecdRecoveryTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecdRecoveryTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecdRecoveryTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecdRecoveryTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecdRecoveryTcpParser(),
    NsecdRecoveryTcpVerifyChecksum(),
    NsecdRecoveryTcpIngress(),
    NsecdRecoveryTcpEgress(),
    NsecdRecoveryTcpComputeChecksum(),
    NsecdRecoveryTcpDeparser()
) main;
