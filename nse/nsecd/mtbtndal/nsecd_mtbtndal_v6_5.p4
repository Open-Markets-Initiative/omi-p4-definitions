// P4_16 (v1model) definition for: Nse NseCd MtbtNdal Binary v6.5
// 
// Protocol:
...
parser NsecdMtbtndalParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecdMtbtndalVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecdMtbtndalIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecdMtbtndalEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecdMtbtndalComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecdMtbtndalDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecdMtbtndalParser(),
    NsecdMtbtndalVerifyChecksum(),
    NsecdMtbtndalIngress(),
    NsecdMtbtndalEgress(),
    NsecdMtbtndalComputeChecksum(),
    NsecdMtbtndalDeparser()
) main;
