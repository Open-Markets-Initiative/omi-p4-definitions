// P4_16 (v1model) definition for: Nse NseCom Snapshot Binary v6.8
// 
// Protocol:
...
control NsecomSnapshotVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecomSnapshotIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecomSnapshotEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecomSnapshotComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    NsecomSnapshotParser(),
    NsecomSnapshotVerifyChecksum(),
    NsecomSnapshotIngress(),
    NsecomSnapshotEgress(),
    NsecomSnapshotComputeChecksum(),
    NsecomSnapshotDeparser()
) main;
