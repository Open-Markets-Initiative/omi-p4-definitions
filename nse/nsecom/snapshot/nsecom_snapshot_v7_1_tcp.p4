...
parser NsecomSnapshotTcpParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecomSnapshotTcpVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecomSnapshotTcpIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecomSnapshotTcpEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecomSnapshotTcpComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecomSnapshotTcpDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecomSnapshotTcpParser(),
    NsecomSnapshotTcpVerifyChecksum(),
    NsecomSnapshotTcpIngress(),
    NsecomSnapshotTcpEgress(),
    NsecomSnapshotTcpComputeChecksum(),
    NsecomSnapshotTcpDeparser()
) main;
