// P4_16 (v1model) definition for: Nse NseCom Mtbt Binary v7.1
// 
// Protocol:
...
parser NsecomMtbtParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control NsecomMtbtVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecomMtbtIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control NsecomMtbtEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control NsecomMtbtComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control NsecomMtbtDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    NsecomMtbtParser(),
    NsecomMtbtVerifyChecksum(),
    NsecomMtbtIngress(),
    NsecomMtbtEgress(),
    NsecomMtbtComputeChecksum(),
    NsecomMtbtDeparser()
) main;
