...
header allocation_report_message_allocation_report_message_allocations_group_t {
    bit<32> alloc_qty;
    bit<8> trading_capacity;
    bit<8> open_or_close;
    bit<8> block_length_short;
...
struct metadata_t {
    ...
    bit<8> allocation_report_message_allocation_report_message_allocations_group_remaining;
}
...
struct headers_t {
    ...
    allocation_report_message_allocation_report_message_allocations_group_t allocation_report_message_allocation_report_message_allocations_group[MAX_MESSAGES];
...
parser MemxoptionsMemoServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_sequenced_message {
        ...
        transition select(hdr.sequenced_message.template_id) {
            ...
            8w28: parse_allocation_report_message;
    ...
    state parse_allocation_report_message {
        ...
        meta.dispatched = 1;
        meta.allocation_report_message_allocation_report_message_allocations_group_remaining = hdr.allocation_report_message.num_in_group;
        transition select(meta.allocation_report_message_allocation_report_message_allocations_group_remaining) {
            8w0: accept;
            default: parse_allocation_report_message_allocation_report_message_allocations_group;
        }
    }

    state parse_allocation_report_message_allocation_report_message_allocations_group {
        packet.extract(hdr.allocation_report_message_allocation_report_message_allocations_group.next);
        meta.allocation_report_message_allocation_report_message_allocations_group_remaining = meta.allocation_report_message_allocation_report_message_allocations_group_remaining - 1;
        transition select(meta.allocation_report_message_allocation_report_message_allocations_group_remaining) {
            8w0: accept;
            default: parse_allocation_report_message_allocation_report_message_allocations_group;
        }
...
control MemxoptionsMemoServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.allocation_report_message_allocation_report_message_allocations_group);
