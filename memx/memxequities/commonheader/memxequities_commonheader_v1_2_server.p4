...
parser MemxequitiesCommonheaderServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MemxequitiesCommonheaderServerVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control MemxequitiesCommonheaderServerEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MemxequitiesCommonheaderServerComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MemxequitiesCommonheaderServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MemxequitiesCommonheaderServerParser(),
    MemxequitiesCommonheaderServerVerifyChecksum(),
    MemxequitiesCommonheaderServerIngress(),
    MemxequitiesCommonheaderServerEgress(),
    MemxequitiesCommonheaderServerComputeChecksum(),
    MemxequitiesCommonheaderServerDeparser()
) main;
