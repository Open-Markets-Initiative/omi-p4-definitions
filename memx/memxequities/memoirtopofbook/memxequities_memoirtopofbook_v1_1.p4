// P4_16 (v1model) definition for: Memx MemxEquities MemoirTopOfBook Sbe v1.1
// 
// Protocol:
...
parser MemxequitiesMemoirtopofbookParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MemxequitiesMemoirtopofbookVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control MemxequitiesMemoirtopofbookEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MemxequitiesMemoirtopofbookComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MemxequitiesMemoirtopofbookDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MemxequitiesMemoirtopofbookParser(),
    MemxequitiesMemoirtopofbookVerifyChecksum(),
    MemxequitiesMemoirtopofbookIngress(),
    MemxequitiesMemoirtopofbookEgress(),
    MemxequitiesMemoirtopofbookComputeChecksum(),
    MemxequitiesMemoirtopofbookDeparser()
) main;
