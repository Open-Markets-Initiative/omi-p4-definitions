...
PROGRAM_CLIENT = "jnx/jnxequities/pts/jnxequities_pts_v1_11_client.p4"
JSON_CLIENT = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "jnxequities_pts_v1_11_client.json")
PROGRAM_SERVER = "jnx/jnxequities/pts/jnxequities_pts_v1_11_server.p4"
JSON_SERVER = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "jnxequities_pts_v1_11_server.json")
P4C = os.environ.get("P4C", "p4c-bm2-ss")


class JnxequitiesPtsV111ClientTests(unittest.TestCase):
...
class JnxequitiesPtsV111ServerTests(unittest.TestCase):
