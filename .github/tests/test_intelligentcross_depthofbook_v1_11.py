...
PROGRAM = "imperative/depthofbook/intelligentcross_depthofbook_v1_11.p4"
JSON = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "intelligentcross_depthofbook_v1_11.json")
