...
PROGRAM = "nyse/amexequities/integratedfeed/amexequities_integratedfeed_v2_5_g.p4"
JSON = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "amexequities_integratedfeed_v2_5_g.json")
