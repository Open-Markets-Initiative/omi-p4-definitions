...
PROGRAM = "nasdaq/nsmequities/totalview/nsmequities_totalview_v2_0_udp.p4"
JSON = os.path.join(os.environ.get("RUNNER_TEMP", "/tmp"), "nsmequities_totalview_v2_0.json")
