// P4_16 (v1model) definition for: OtcMarkets MoonAts TopOfBook Link v1.3
// 
// Protocol:
...
parser MoonatsTopofbookParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control MoonatsTopofbookVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MoonatsTopofbookIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control MoonatsTopofbookEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control MoonatsTopofbookComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control MoonatsTopofbookDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    MoonatsTopofbookParser(),
    MoonatsTopofbookVerifyChecksum(),
    MoonatsTopofbookIngress(),
    MoonatsTopofbookEgress(),
    MoonatsTopofbookComputeChecksum(),
    MoonatsTopofbookDeparser()
) main;
