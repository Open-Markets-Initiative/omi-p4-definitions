// P4_16 (v1model) definition for: OtcMarkets Overnight DepthOfBook Link v1.0
// 
// Protocol:
...
control OvernightDepthofbookVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control OvernightDepthofbookEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control OvernightDepthofbookComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    OvernightDepthofbookParser(),
    OvernightDepthofbookVerifyChecksum(),
    OvernightDepthofbookIngress(),
    OvernightDepthofbookEgress(),
    OvernightDepthofbookComputeChecksum(),
    OvernightDepthofbookDeparser()
) main;
