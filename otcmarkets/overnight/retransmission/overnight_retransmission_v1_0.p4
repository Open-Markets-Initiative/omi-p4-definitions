// P4_16 (v1model) definition for: OtcMarkets Overnight Retransmission Link v1.0
// 
// Protocol:
...
parser OvernightRetransmissionParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control OvernightRetransmissionVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control OvernightRetransmissionEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control OvernightRetransmissionComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control OvernightRetransmissionDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    OvernightRetransmissionParser(),
    OvernightRetransmissionVerifyChecksum(),
    OvernightRetransmissionIngress(),
    OvernightRetransmissionEgress(),
    OvernightRetransmissionComputeChecksum(),
    OvernightRetransmissionDeparser()
) main;
