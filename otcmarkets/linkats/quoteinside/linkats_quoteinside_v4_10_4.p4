// P4_16 (v1model) definition for: OtcMarkets LinkAts QuoteInside Link v4.10.4
// 
// Protocol:
...
parser LinkatsQuoteinsideParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control LinkatsQuoteinsideVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control LinkatsQuoteinsideIngress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
...
control LinkatsQuoteinsideEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control LinkatsQuoteinsideComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control LinkatsQuoteinsideDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    LinkatsQuoteinsideParser(),
    LinkatsQuoteinsideVerifyChecksum(),
    LinkatsQuoteinsideIngress(),
    LinkatsQuoteinsideEgress(),
    LinkatsQuoteinsideComputeChecksum(),
    LinkatsQuoteinsideDeparser()
) main;
