// P4_16 (v1model) definition for: OtcMarkets LinkAts QuoteReferencePrice Link v4.10.4
// 
// Protocol:
...
header reference_price_message_t {
    ...
    bit<1> third_reserved_1;
    bit<1> bid_priced;
    bit<1> fourth_reserved_1;
    bit<32> security_id;
    bit<64> ask_price;
    bit<32> ask_size;
...
control LinkatsQuotereferencepriceVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control LinkatsQuotereferencepriceEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control LinkatsQuotereferencepriceComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
V1Switch(
    LinkatsQuotereferencepriceParser(),
    LinkatsQuotereferencepriceVerifyChecksum(),
    LinkatsQuotereferencepriceIngress(),
    LinkatsQuotereferencepriceEgress(),
    LinkatsQuotereferencepriceComputeChecksum(),
    LinkatsQuotereferencepriceDeparser()
) main;
