// P4_16 (v1model) definition for: Asx AsxSecurities Trade Itch v3.1
// 
// Protocol:
...
header combination_order_book_directory_message_t {
    ...
    bit<8> leg_side;
    bit<32> leg_ratio;
    bit<256> leg_symbol_2;
    bit<8> leg_side_2;
    bit<32> leg_ratio_2;
    bit<256> leg_symbol_3;
    bit<8> leg_side_3;
    bit<32> leg_ratio_3;
    bit<256> leg_symbol_4;
    bit<8> leg_side_4;
    bit<32> leg_ratio_4;
}
...
header add_order_no_participant_id_message_t {
    ...
    bit<1> reserved_bit;
    bit<1> undisclosed;
    bit<7> reserved_7_bits;
    bit<1> implied_order;
    bit<2> unused_reserved_2_bits;
    bit<8> lot_type;
}
