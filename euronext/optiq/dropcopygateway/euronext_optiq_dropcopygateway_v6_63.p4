// P4_16 (v1model) definition for: Euronext Optiq DropCopyGateway Sbe v6.63
// 
// Protocol:
...
header long_order_message_t {
    ...
    bit<1> dea_indicator;
    bit<64> oegin_from_member_optional;
    bit<64> oegout_time_to_me_optional;
    bit<64> order_id;
    ...
    bit<8> execution_phase_optional;
    bit<64> last_shares_optional;
    bit<64> last_traded_px_optional;
    bit<64> leaves_qty;
...
header long_order_message_long_order_clearing_fields_group_t {
    bit<64> clearing_firm_id_optional;
    bit<64> client_id;
...
header dc_short_order_reject_message_t {
    ...
    bit<1> investment_algo_indicator;
    bit<1> dea_indicator;
    bit<64> oe_session_id_optional;
    bit<8> order_side_optional;
...
header dc_trade_message_d_c_trade_message_matched_orders_group_t {
    ...
    bit<1> first_trade_price;
    bit<1> uncrossing_trade;
    bit<8> account_type_internal_optional;
    bit<8> lp_role_optional;
    bit<128> clearing_account;
    bit<144> free_text;
    bit<64> clearing_firm_id_optional;
    bit<128> trader_id;
    bit<128> original_investor_id;
    bit<8> cross_order_indicator_optional;
