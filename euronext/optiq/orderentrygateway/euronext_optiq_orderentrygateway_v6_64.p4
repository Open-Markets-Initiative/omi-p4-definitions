// P4_16 (v1model) definition for: Euronext Optiq OrderEntryGateway Sbe v6.64
// 
// Protocol:
...
header new_order_message_optional_ids_group_header_t {
    bit<8> block_length_short;
    bit<8> num_in_group;
}

header new_order_message_optional_ids_group_t {
    bit<32> lpid;
}
...
header quote_request_message_new_order_message_free_text_section_group_t {
    bit<144> free_text;
}

header quote_request_message_rfq_optional_field_group_header_t {
    bit<8> block_length_short;
    bit<8> num_in_group;
}

header quote_request_message_rfq_optional_field_group_t {
...
header mass_cancel_message_t {
    ...
    bit<8> side_optional;
    bit<32> logical_access_id_optional;
...
struct metadata_t {
    ...
    bit<8> new_order_message_optional_ids_group_remaining;
    ...
    bit<8> quote_request_message_new_order_message_free_text_section_group_remaining;
    bit<8> quote_request_message_rfq_optional_field_group_remaining;
...
struct headers_t {
    ...
    new_order_message_optional_ids_group_header_t new_order_message_optional_ids_group_header;
    new_order_message_optional_ids_group_t new_order_message_optional_ids_group[MAX_MESSAGES];
    ...
    quote_request_message_new_order_message_free_text_section_group_t quote_request_message_new_order_message_free_text_section_group[MAX_MESSAGES];
    quote_request_message_rfq_optional_field_group_header_t quote_request_message_rfq_optional_field_group_header;
    quote_request_message_rfq_optional_field_group_t quote_request_message_rfq_optional_field_group[MAX_MESSAGES];
...
parser EuronextOptiqOrderentrygatewayParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0x2500: parse_rfqlp_matching_status_message;
            16w0x2700: parse_user_notification_message;
            16w0x2f00: parse_mm_sign_in_message;
            16w0x3000: parse_mm_sign_in_ack_message;
            16w0x3200: parse_instrument_synchronization_list_message;
            16w0x3300: parse_synchronization_time_message;
            16w0x3c00: parse_security_definition_request_message;
            16w0x3d00: parse_security_definition_ack_message;
            16w0x3e00: parse_mm_protection_request_message;
            16w0x3f00: parse_mm_protection_ack_message;
            16w0x4000: parse_new_wholesale_order_message;
            16w0x4100: parse_wholesale_order_ack_message;
            16w0x4200: parse_request_for_implied_execution_message;
            16w0x4300: parse_cross_order_message;
            16w0x4800: parse_rfq_audit_message;
            16w0x4900: parse_wave_for_liquidity_message;
            16w0x4a00: parse_wave_for_liquidity_notification_message;
            16w0x4b00: parse_clear_book_message;
    ...
    state read_new_order_message_additional_infos_group {
        ...
        transition select(meta.new_order_message_additional_infos_group_remaining) {
            8w0: read_new_order_message_optional_ids_group;
    ...
    state read_new_order_message_optional_ids_group {
        packet.extract(hdr.new_order_message_optional_ids_group_header);
        meta.new_order_message_optional_ids_group_remaining = hdr.new_order_message_optional_ids_group_header.num_in_group;
        transition select(meta.new_order_message_optional_ids_group_remaining) {
            8w0: accept;
            default: parse_new_order_message_optional_ids_group;
        }
    }

    state parse_new_order_message_optional_ids_group {
        packet.extract(hdr.new_order_message_optional_ids_group.next);
        meta.new_order_message_optional_ids_group_remaining = meta.new_order_message_optional_ids_group_remaining - 1;
        transition select(meta.new_order_message_optional_ids_group_remaining) {
            8w0: accept;
            default: parse_new_order_message_optional_ids_group;
        }
    ...
    state parse_quote_request_message {
        ...
        meta.dispatched = 1;
        meta.quote_request_message_new_order_message_free_text_section_group_remaining = hdr.quote_request_message.num_in_group;
        transition select(meta.quote_request_message_new_order_message_free_text_section_group_remaining) {
            8w0: read_quote_request_message_rfq_optional_field_group;
            default: parse_quote_request_message_new_order_message_free_text_section_group;
        }
    }

    state parse_quote_request_message_new_order_message_free_text_section_group {
        packet.extract(hdr.quote_request_message_new_order_message_free_text_section_group.next);
        meta.quote_request_message_new_order_message_free_text_section_group_remaining = meta.quote_request_message_new_order_message_free_text_section_group_remaining - 1;
        transition select(meta.quote_request_message_new_order_message_free_text_section_group_remaining) {
            8w0: read_quote_request_message_rfq_optional_field_group;
            default: parse_quote_request_message_new_order_message_free_text_section_group;
        }
    ...
    state read_quote_request_message_rfq_optional_field_group {
        packet.extract(hdr.quote_request_message_rfq_optional_field_group_header);
        meta.quote_request_message_rfq_optional_field_group_remaining = hdr.quote_request_message_rfq_optional_field_group_header.num_in_group;
        transition select(meta.quote_request_message_rfq_optional_field_group_remaining) {
            8w0: accept;
            default: parse_quote_request_message_rfq_optional_field_group;
        }
    }

    state parse_quote_request_message_rfq_optional_field_group {
        packet.extract(hdr.quote_request_message_rfq_optional_field_group.next);
        meta.quote_request_message_rfq_optional_field_group_remaining = meta.quote_request_message_rfq_optional_field_group_remaining - 1;
        transition select(meta.quote_request_message_rfq_optional_field_group_remaining) {
            8w0: accept;
            default: parse_quote_request_message_rfq_optional_field_group;
        }
...
control EuronextOptiqOrderentrygatewayDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.new_order_message_optional_ids_group_header);
        packet.emit(hdr.new_order_message_optional_ids_group);
        ...
        packet.emit(hdr.quote_request_message_new_order_message_free_text_section_group);
        packet.emit(hdr.quote_request_message_rfq_optional_field_group_header);
        packet.emit(hdr.quote_request_message_rfq_optional_field_group);
