// P4_16 (v1model) definition for: Euronext Optiq MarketDataGateway Sbe v6.69
// 
// Protocol:
...
header full_trade_information_message_t {
    ...
    bit<32> missing_price;
    bit<32> mmt_pre_trade_transparency_waiver_relatedto_sizeand_scale;
    bit<32> mmt_portfolio_transaction_indicator;
    bit<32> mmt_contingent_transaction_indicator;
    bit<32> mmt_publication_mode_illiquid;
    bit<32> mmt_publication_mode_size_specific;
    bit<32> venueof_publication;
    bit<32> post_trade_deferral_flags;
    bit<8> block_length_short;
    bit<8> num_in_group;
}
...
header market_status_change_message_t {
    ...
    bit<1> unused_phase_qualifierset_8;
...
header standing_data_message_t {
    ...
    bit<48> long_mnemonic;
    bit<64> max_order_amount_call;
    bit<64> max_order_amount_continuous;
    bit<64> max_order_quantity_call;
    bit<64> max_order_quantity_continuous;
    bit<32> pool_factor;
    bit<8> block_length_short;
    bit<8> num_in_group;
    bit<8> emm;
...
header contract_standing_data_message_t {
    ...
    bit<1> ics_one_sided_combination_same_expiry;
    bit<1> ics_two_sided_combination_same_expiry;
    bit<1> ratio_inter_contract_spread;
    bit<1> call_spread_versus_put_or_put_spread_versus_call;
    bit<1> ratio_spread_option;
    bit<11> reserved_11;
...
parser EuronextOptiqMarketdatagatewayParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0x5204: parse_technical_notification_message;
            16w0xe903: parse_market_update_message;
            16w0xea03: parse_order_update_message;
            16w0xeb03: parse_price_update_message;
            16w0xec03: parse_full_trade_information_message;
            16w0xed03: parse_market_status_change_message;
            16w0xee03: parse_timetable_message;
            16w0xef03: parse_standing_data_message;
            16w0xf003: parse_real_time_index_message;
            16w0xf103: parse_statistics_message;
            16w0xf303: parse_index_summary_message;
            16w0xf403: parse_strategy_standing_data_message;
            16w0xf503: parse_contract_standing_data_message;
            16w0xf603: parse_outright_standing_data_message;
            16w0xf703: parse_long_order_update_message;
            16w0xf803: parse_lis_package_structure_message;
            16w0x204: parse_apa_quotes_message;
            16w0x304: parse_apa_standing_data_message;
            16w0x404: parse_apa_full_trade_information_message;
            16w0xb104: parse_bf_instrument_reference_message;
            16w0xb204: parse_bf_trade_message;
            16w0xb304: parse_bfnav_message;
            16w0xb404: parse_bf_instrument_suspension_message;
            16w0x3508: parse_start_of_snapshot_message;
            16w0x3608: parse_end_of_snapshot_message;
            default: accept;
        }
    }
