// P4_16 (v1model) definition for: Ice IceFutures Mdf iMpact v1.1.51
// 
// Protocol:
...
header interval_price_limit_notification_message_t {
    bit<32> market_id;
    bit<8> ipl_tpl_hold_type;
    bit<64> notification_date_time;
    bit<8> is_up;
    bit<32> ipl_tpl_hold_duration;
    bit<64> ipl_tpl_up;
    bit<64> ipl_tpl_down;
    bit<8> ipl_tpl_type;
}
...
parser IcefuturesMdfParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_special_field_message_special_field {
        ...
        transition select(hdr.special_field_message_special_field.last.special_field_id) {
            ...
            8w6: parse_aon;
            8w18: parse_accrued_distribution;
            8w19: parse_accrued_funding;
            8w20: parse_annualization_factor;
            8w21: parse_trf_days_to_maturity;
            8w22: parse_seconds_to_end_tpl_hold;
            default: parse_packet_header_message;
        }
    }
    ...
    state parse_accrued_distribution {
        meta.dispatched = 1;
        transition parse_special_field_message_special_field;
    }

    state parse_accrued_funding {
        meta.dispatched = 1;
        transition parse_special_field_message_special_field;
    }

    state parse_annualization_factor {
        meta.dispatched = 1;
        transition parse_special_field_message_special_field;
    }

    state parse_trf_days_to_maturity {
        meta.dispatched = 1;
        transition parse_special_field_message_special_field;
    }

    state parse_seconds_to_end_tpl_hold {
        meta.dispatched = 1;
        transition parse_special_field_message_special_field;
    }
