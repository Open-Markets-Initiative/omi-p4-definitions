...
header basket_roll_broadcast_basket_root_party_grp_comp_t {
    bit<16> root_party_sub_id_type;
    bit<40> root_party_contra_firm;
    bit<48> root_party_contra_trader;
    bit<160> basket_side_trade_report_id;
...
header basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_t {
    bit<64> security_id;
    bit<64> last_px;
    bit<64> trans_bkd_time;
    bit<64> related_close_price;
...
header basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_t {
    bit<64> security_id;
    bit<64> last_px;
    bit<64> trans_bkd_time;
    bit<64> related_close_price;
...
header basket_roll_broadcast_old_basket_side_alloc_grp_comp_t {
    bit<64> alloc_qty;
    bit<32> individual_alloc_id;
    bit<16> party_sub_id_type;
    bit<8> side;
...
header basket_roll_broadcast_new_basket_side_alloc_grp_comp_t {
    bit<64> alloc_qty;
    bit<32> individual_alloc_id;
    bit<16> party_sub_id_type;
    bit<8> side;
...
header srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_t {
    bit<64> transact_time;
    bit<64> expire_time;
    bit<64> quote_id;
    bit<64> secondary_quote_id;
...
header tes_broadcast_trd_clearing_price_leg_grp_comp_t {
    bit<64> leg_security_id;
...
header tes_inquire_boundary_prices_response_t {
    bit<16> pad2;
    bit<64> request_time;
    bit<64> sending_time;
    bit<32> msg_seq_num;
    bit<32> pad4;
    bit<64> min_boundary_price;
    bit<64> max_boundary_price;
    bit<32> market_segment_id;
    bit<32> pad4_2;
}
...
header trading_action_response_matching_engine_status_grp_comp_t {
    bit<16> partition_id;
    bit<8> matching_engine_status;
    bit<40> pad5;
}
...
header update_reference_prices_response_t {
    bit<16> pad2;
    bit<64> request_time;
    bit<64> sending_time;
    bit<32> msg_seq_num;
...
header update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_t {
    bit<40> party_detail_executing_unit;
    bit<8> pad1;
...
struct metadata_t {
    ...
    bit<8> basket_roll_broadcast_basket_root_party_grp_comp_remaining;
    bit<8> basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_remaining;
    bit<8> basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_remaining;
    bit<16> basket_roll_broadcast_old_basket_side_alloc_grp_comp_remaining;
    bit<16> basket_roll_broadcast_new_basket_side_alloc_grp_comp_remaining;
    ...
    bit<8> srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_remaining;
    ...
    bit<8> tes_broadcast_trd_clearing_price_leg_grp_comp_remaining;
    ...
    bit<8> trading_action_response_matching_engine_status_grp_comp_remaining;
    bit<16> update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_remaining;
}
...
struct headers_t {
    ...
    basket_roll_broadcast_basket_root_party_grp_comp_t basket_roll_broadcast_basket_root_party_grp_comp[MAX_MESSAGES];
    basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_t basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp[MAX_MESSAGES];
    basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_t basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp[MAX_MESSAGES];
    basket_roll_broadcast_old_basket_side_alloc_grp_comp_t basket_roll_broadcast_old_basket_side_alloc_grp_comp[MAX_MESSAGES];
    basket_roll_broadcast_new_basket_side_alloc_grp_comp_t basket_roll_broadcast_new_basket_side_alloc_grp_comp[MAX_MESSAGES];
    ...
    srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_t srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp[MAX_MESSAGES];
    ...
    tes_broadcast_trd_clearing_price_leg_grp_comp_t tes_broadcast_trd_clearing_price_leg_grp_comp[MAX_MESSAGES];
    ...
    tes_inquire_boundary_prices_response_t tes_inquire_boundary_prices_response;
    ...
    trading_action_response_matching_engine_status_grp_comp_t trading_action_response_matching_engine_status_grp_comp[MAX_MESSAGES];
    trading_session_status_broadcast_t trading_session_status_broadcast;
    unsubscribe_response_t unsubscribe_response;
    update_reference_prices_response_t update_reference_prices_response;
    update_remaining_risk_allowance_base_response_t update_remaining_risk_allowance_base_response;
    update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_t update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp[MAX_MESSAGES];
...
parser EurexT7EtiServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0x5828: parse_add_scaled_simple_instrument_response;
            16w0x8329: parse_basket_approve_broadcast;
            16w0x8129: parse_basket_broadcast;
            16w0x8229: parse_basket_delete_broadcast;
            16w0x8429: parse_basket_execution_broadcast;
            16w0x8029: parse_basket_response;
            16w0x8a29: parse_basket_roll_broadcast;
            16w0x3027: parse_broadcast_error_notification;
            16w0x9627: parse_clip_deletion_notification;
            16w0x9727: parse_clip_execution_notification;
            16w0x9527: parse_clip_response;
            ...
            16w0x5428: parse_inquire_margin_based_risk_limit_response;
            ...
            16w0x8427: parse_mass_order_ack;
            ...
            16w0xd429: parse_srqs_create_deal_notification;
            16w0xd529: parse_srqs_deal_notification;
            16w0xd129: parse_srqs_deal_response;
            16w0xdf29: parse_srqs_inquire_smart_respondent_response;
            16w0xd929: parse_srqs_negotiation_notification;
            16w0xd829: parse_srqs_negotiation_requester_notification;
            16w0xdb29: parse_srqs_negotiation_status_notification;
            16w0xd729: parse_srqs_open_negotiation_notification;
            16w0xd629: parse_srqs_open_negotiation_requester_notification;
            16w0xd329: parse_srqs_quote_notification;
            16w0xcf29: parse_srqs_quote_response;
            16w0xe329: parse_srqs_quote_snapshot_notification;
            16w0xe229: parse_srqs_response;
            16w0xda29: parse_srqs_status_broadcast;
            ...
            16w0x5a28: parse_tes_inquire_boundary_prices_response;
            16w0x7329: parse_tes_response;
            16w0x8829: parse_tes_reversal_broadcast;
            ...
            16w0x992a: parse_trading_action_response;
            16w0x4328: parse_trading_session_status_broadcast;
            16w0x1727: parse_unsubscribe_response;
            16w0x5c28: parse_update_reference_prices_response;
            16w0x5628: parse_update_remaining_risk_allowance_base_response;
    ...
    state parse_add_complex_instrument_response {
        ...
        meta.dispatched = 1;
        meta.add_complex_instrument_response_instrmt_leg_grp_comp_remaining = hdr.add_complex_instrument_response.no_leg_onbooks;
    ...
    state parse_basket_roll_broadcast {
        ...
        meta.dispatched = 1;
        meta.basket_roll_broadcast_basket_root_party_grp_comp_remaining = hdr.basket_roll_broadcast.no_basket_root_party_grps_bc;
        transition select(meta.basket_roll_broadcast_basket_root_party_grp_comp_remaining) {
            8w0: read_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp;
            default: parse_basket_roll_broadcast_basket_root_party_grp_comp;
        }
    }

    state parse_basket_roll_broadcast_basket_root_party_grp_comp {
        packet.extract(hdr.basket_roll_broadcast_basket_root_party_grp_comp.next);
        meta.basket_roll_broadcast_basket_root_party_grp_comp_remaining = meta.basket_roll_broadcast_basket_root_party_grp_comp_remaining - 1;
        transition select(meta.basket_roll_broadcast_basket_root_party_grp_comp_remaining) {
            8w0: read_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp;
            default: parse_basket_roll_broadcast_basket_root_party_grp_comp;
        }
    ...
    state read_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp {
        meta.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_remaining = hdr.basket_roll_broadcast.no_old_basket_instrmt_match_sides;
        transition select(meta.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_remaining) {
            8w0: read_basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp;
            default: parse_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp;
        }
    }

    state parse_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp {
        packet.extract(hdr.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp.next);
        meta.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_remaining = meta.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_remaining - 1;
        transition select(meta.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_remaining) {
            8w0: read_basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp;
            default: parse_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp;
        }
    ...
    state read_basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp {
        meta.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_remaining = hdr.basket_roll_broadcast.no_new_basket_instrmt_match_sides;
        transition select(meta.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_remaining) {
            8w0: read_basket_roll_broadcast_old_basket_side_alloc_grp_comp;
            default: parse_basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp;
        }
    }

    state parse_basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp {
        packet.extract(hdr.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp.next);
        meta.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_remaining = meta.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_remaining - 1;
        transition select(meta.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp_remaining) {
            8w0: read_basket_roll_broadcast_old_basket_side_alloc_grp_comp;
            default: parse_basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp;
        }
    ...
    state read_basket_roll_broadcast_old_basket_side_alloc_grp_comp {
        meta.basket_roll_broadcast_old_basket_side_alloc_grp_comp_remaining = hdr.basket_roll_broadcast.no_old_basket_side_alloc;
        transition select(meta.basket_roll_broadcast_old_basket_side_alloc_grp_comp_remaining) {
            16w0: read_basket_roll_broadcast_new_basket_side_alloc_grp_comp;
            default: parse_basket_roll_broadcast_old_basket_side_alloc_grp_comp;
        }
    }

    state parse_basket_roll_broadcast_old_basket_side_alloc_grp_comp {
        packet.extract(hdr.basket_roll_broadcast_old_basket_side_alloc_grp_comp.next);
        meta.basket_roll_broadcast_old_basket_side_alloc_grp_comp_remaining = meta.basket_roll_broadcast_old_basket_side_alloc_grp_comp_remaining - 1;
        transition select(meta.basket_roll_broadcast_old_basket_side_alloc_grp_comp_remaining) {
            16w0: read_basket_roll_broadcast_new_basket_side_alloc_grp_comp;
            default: parse_basket_roll_broadcast_old_basket_side_alloc_grp_comp;
        }
    ...
    state read_basket_roll_broadcast_new_basket_side_alloc_grp_comp {
        meta.basket_roll_broadcast_new_basket_side_alloc_grp_comp_remaining = hdr.basket_roll_broadcast.no_new_basket_side_alloc;
        transition select(meta.basket_roll_broadcast_new_basket_side_alloc_grp_comp_remaining) {
            16w0: accept;
            default: parse_basket_roll_broadcast_new_basket_side_alloc_grp_comp;
        }
    }

    state parse_basket_roll_broadcast_new_basket_side_alloc_grp_comp {
        packet.extract(hdr.basket_roll_broadcast_new_basket_side_alloc_grp_comp.next);
        meta.basket_roll_broadcast_new_basket_side_alloc_grp_comp_remaining = meta.basket_roll_broadcast_new_basket_side_alloc_grp_comp_remaining - 1;
        transition select(meta.basket_roll_broadcast_new_basket_side_alloc_grp_comp_remaining) {
            16w0: accept;
            default: parse_basket_roll_broadcast_new_basket_side_alloc_grp_comp;
        }
    ...
    state parse_order_exec_report_broadcast {
        ...
        meta.dispatched = 1;
        meta.order_exec_report_broadcast_leg_ord_grp_comp_remaining = hdr.order_exec_report_broadcast.no_leg_onbooks;
    ...
    state parse_srqs_quote_snapshot_notification {
        ...
        meta.dispatched = 1;
        meta.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_remaining = hdr.srqs_quote_snapshot_notification.no_quote_entries;
        transition select(meta.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_remaining) {
            8w0: accept;
            default: parse_srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp;
        }
    }

    state parse_srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp {
        packet.extract(hdr.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp.next);
        meta.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_remaining = meta.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_remaining - 1;
        transition select(meta.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp_remaining) {
            8w0: accept;
            default: parse_srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp;
        }
    ...
    state read_tes_broadcast_instrument_event_grp_comp {
        ...
        transition select(meta.tes_broadcast_instrument_event_grp_comp_remaining) {
            8w0: read_tes_broadcast_trd_clearing_price_leg_grp_comp;
    ...
    state read_tes_broadcast_trd_clearing_price_leg_grp_comp {
        meta.tes_broadcast_trd_clearing_price_leg_grp_comp_remaining = hdr.tes_broadcast.no_leg_clearing_prices;
        transition select(meta.tes_broadcast_trd_clearing_price_leg_grp_comp_remaining) {
            8w0: read_tes_broadcast_instrument_attribute_grp_comp;
            default: parse_tes_broadcast_trd_clearing_price_leg_grp_comp;
        }
    }

    state parse_tes_broadcast_trd_clearing_price_leg_grp_comp {
        packet.extract(hdr.tes_broadcast_trd_clearing_price_leg_grp_comp.next);
        meta.tes_broadcast_trd_clearing_price_leg_grp_comp_remaining = meta.tes_broadcast_trd_clearing_price_leg_grp_comp_remaining - 1;
        transition select(meta.tes_broadcast_trd_clearing_price_leg_grp_comp_remaining) {
            8w0: read_tes_broadcast_instrument_attribute_grp_comp;
            default: parse_tes_broadcast_trd_clearing_price_leg_grp_comp;
        }
    ...
    state parse_tes_inquire_boundary_prices_response {
        packet.extract(hdr.tes_inquire_boundary_prices_response);
        meta.dispatched = 1;
        transition accept;
    }
    ...
    state parse_trading_action_response {
        ...
        meta.dispatched = 1;
        meta.trading_action_response_matching_engine_status_grp_comp_remaining = hdr.trading_action_response.no_partition_i_ds;
        transition select(meta.trading_action_response_matching_engine_status_grp_comp_remaining) {
            8w0: accept;
            default: parse_trading_action_response_matching_engine_status_grp_comp;
        }
    }

    state parse_trading_action_response_matching_engine_status_grp_comp {
        packet.extract(hdr.trading_action_response_matching_engine_status_grp_comp.next);
        meta.trading_action_response_matching_engine_status_grp_comp_remaining = meta.trading_action_response_matching_engine_status_grp_comp_remaining - 1;
        transition select(meta.trading_action_response_matching_engine_status_grp_comp_remaining) {
            8w0: accept;
            default: parse_trading_action_response_matching_engine_status_grp_comp;
        }
    ...
    state parse_update_reference_prices_response {
        packet.extract(hdr.update_reference_prices_response);
        meta.dispatched = 1;
        transition accept;
    }
    ...
    state parse_update_remaining_risk_allowance_base_response {
        ...
        meta.dispatched = 1;
        meta.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_remaining = hdr.update_remaining_risk_allowance_base_response.no_party_risk_limits;
        transition select(meta.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_remaining) {
            16w0: accept;
            default: parse_update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp;
        }
    }

    state parse_update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp {
        packet.extract(hdr.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp.next);
        meta.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_remaining = meta.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_remaining - 1;
        transition select(meta.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp_remaining) {
            16w0: accept;
            default: parse_update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp;
        }
...
control EurexT7EtiServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.basket_roll_broadcast_basket_root_party_grp_comp);
        packet.emit(hdr.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp);
        packet.emit(hdr.basket_roll_broadcast_new_basket_instrmt_match_side_grp_comp);
        packet.emit(hdr.basket_roll_broadcast_old_basket_side_alloc_grp_comp);
        packet.emit(hdr.basket_roll_broadcast_new_basket_side_alloc_grp_comp);
        ...
        packet.emit(hdr.srqs_quote_snapshot_notification_srqs_quote_entry_grp_comp);
        ...
        packet.emit(hdr.tes_broadcast_trd_clearing_price_leg_grp_comp);
        ...
        packet.emit(hdr.tes_inquire_boundary_prices_response);
        ...
        packet.emit(hdr.trading_action_response_matching_engine_status_grp_comp);
        packet.emit(hdr.trading_session_status_broadcast);
        packet.emit(hdr.unsubscribe_response);
        packet.emit(hdr.update_reference_prices_response);
        packet.emit(hdr.update_remaining_risk_allowance_base_response);
        packet.emit(hdr.update_remaining_risk_allowance_base_response_rra_update_base_party_ack_grp_comp);
