...
header basket_roll_request_old_basket_instrmt_match_side_grp_comp_header_t {
    bit<64> basket_trd_match_id;
    bit<32> basket_exec_id;
    bit<160> trade_report_id;
    bit<32> maturity_month_year;
...
struct headers_t {
    ...
    basket_roll_request_old_basket_instrmt_match_side_grp_comp_header_t basket_roll_request_old_basket_instrmt_match_side_grp_comp_header;
...
parser EurexT7EtiClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state read_basket_roll_request_old_basket_instrmt_match_side_grp_comp {
        packet.extract(hdr.basket_roll_request_old_basket_instrmt_match_side_grp_comp_header);
    ...
    state parse_modify_order_complex_request {
        ...
        meta.dispatched = 1;
        meta.modify_order_complex_request_leg_ord_grp_comp_remaining = hdr.modify_order_complex_request.no_leg_onbooks;
    ...
    state parse_new_order_complex_request {
        ...
        meta.dispatched = 1;
        meta.new_order_complex_request_leg_ord_grp_comp_remaining = hdr.new_order_complex_request.no_leg_onbooks;
...
control EurexT7EtiClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.basket_roll_request_old_basket_instrmt_match_side_grp_comp_header);
