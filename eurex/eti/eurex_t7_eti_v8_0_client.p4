...
header enter_tes_trade_request_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
header modify_tes_trade_request_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
header upload_tes_trade_request_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
struct metadata_t {
    ...
    bit<8> amend_basket_trade_request_basket_side_alloc_grp_comp_remaining;
    bit<8> approve_basket_trade_request_basket_side_alloc_ext_grp_comp_remaining;
    ...
    bit<8> enter_basket_trade_request_basket_side_alloc_grp_comp_remaining;
    ...
    bit<8> enter_tes_trade_request_srqs_related_trade_id_grp_comp_remaining;
    ...
    bit<8> modify_basket_trade_request_basket_side_alloc_grp_comp_remaining;
    ...
    bit<8> modify_tes_trade_request_srqs_related_trade_id_grp_comp_remaining;
    ...
    bit<8> upload_tes_trade_request_srqs_related_trade_id_grp_comp_remaining;
}
...
struct headers_t {
    ...
    enter_tes_trade_request_srqs_related_trade_id_grp_comp_t enter_tes_trade_request_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
    ...
    modify_tes_trade_request_srqs_related_trade_id_grp_comp_t modify_tes_trade_request_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
    ...
    upload_tes_trade_request_srqs_related_trade_id_grp_comp_t upload_tes_trade_request_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
...
parser EurexT7EtiClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state read_enter_tes_trade_request_underlying_stip_grp_comp {
        ...
        transition select(meta.enter_tes_trade_request_underlying_stip_grp_comp_remaining) {
            8w0: read_enter_tes_trade_request_srqs_related_trade_id_grp_comp;
    ...
    state read_enter_tes_trade_request_srqs_related_trade_id_grp_comp {
        meta.enter_tes_trade_request_srqs_related_trade_id_grp_comp_remaining = hdr.enter_tes_trade_request.no_srqs_related_trade_i_ds;
        transition select(meta.enter_tes_trade_request_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_enter_tes_trade_request_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_enter_tes_trade_request_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.enter_tes_trade_request_srqs_related_trade_id_grp_comp.next);
        meta.enter_tes_trade_request_srqs_related_trade_id_grp_comp_remaining = meta.enter_tes_trade_request_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.enter_tes_trade_request_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_enter_tes_trade_request_srqs_related_trade_id_grp_comp;
        }
    ...
    state read_modify_tes_trade_request_trd_instrmnt_leg_grp_comp {
        ...
        transition select(meta.modify_tes_trade_request_trd_instrmnt_leg_grp_comp_remaining) {
            8w0: read_modify_tes_trade_request_srqs_related_trade_id_grp_comp;
    ...
    state read_modify_tes_trade_request_srqs_related_trade_id_grp_comp {
        meta.modify_tes_trade_request_srqs_related_trade_id_grp_comp_remaining = hdr.modify_tes_trade_request.no_srqs_related_trade_i_ds;
        transition select(meta.modify_tes_trade_request_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_modify_tes_trade_request_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_modify_tes_trade_request_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.modify_tes_trade_request_srqs_related_trade_id_grp_comp.next);
        meta.modify_tes_trade_request_srqs_related_trade_id_grp_comp_remaining = meta.modify_tes_trade_request_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.modify_tes_trade_request_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_modify_tes_trade_request_srqs_related_trade_id_grp_comp;
        }
    ...
    state read_upload_tes_trade_request_underlying_stip_grp_comp {
        ...
        transition select(meta.upload_tes_trade_request_underlying_stip_grp_comp_remaining) {
            8w0: read_upload_tes_trade_request_srqs_related_trade_id_grp_comp;
    ...
    state read_upload_tes_trade_request_srqs_related_trade_id_grp_comp {
        meta.upload_tes_trade_request_srqs_related_trade_id_grp_comp_remaining = hdr.upload_tes_trade_request.no_srqs_related_trade_i_ds;
        transition select(meta.upload_tes_trade_request_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_upload_tes_trade_request_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_upload_tes_trade_request_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.upload_tes_trade_request_srqs_related_trade_id_grp_comp.next);
        meta.upload_tes_trade_request_srqs_related_trade_id_grp_comp_remaining = meta.upload_tes_trade_request_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.upload_tes_trade_request_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_upload_tes_trade_request_srqs_related_trade_id_grp_comp;
        }
...
control EurexT7EtiClientDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.enter_tes_trade_request_srqs_related_trade_id_grp_comp);
        ...
        packet.emit(hdr.modify_tes_trade_request_srqs_related_trade_id_grp_comp);
        ...
        packet.emit(hdr.upload_tes_trade_request_srqs_related_trade_id_grp_comp);
