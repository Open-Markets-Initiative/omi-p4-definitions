// P4_16 (v1model) definition for: Eurex T7 Eti Fbe v8.1
// 
// Protocol:
...
header tes_approve_broadcast_t {
    ...
    bit<32> negotiation_id;
    bit<8> no_srqs_related_trade_i_ds;
    bit<24> pad3;
...
header tes_approve_broadcast_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
header tes_broadcast_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
header tes_trade_broadcast_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
header tes_upload_broadcast_srqs_related_trade_id_grp_comp_t {
    bit<32> srqs_related_trade_id;
    bit<32> pad4;
}
...
struct metadata_t {
    ...
    bit<8> basket_approve_broadcast_basket_side_alloc_ext_bc_grp_comp_remaining;
    bit<8> basket_broadcast_basket_root_party_grp_comp_remaining;
    bit<8> basket_broadcast_instrmt_match_side_grp_comp_remaining;
    bit<8> basket_broadcast_basket_side_alloc_grp_comp_remaining;
    ...
    bit<8> tes_approve_broadcast_srqs_related_trade_id_grp_comp_remaining;
    ...
    bit<8> tes_broadcast_srqs_related_trade_id_grp_comp_remaining;
    bit<8> tes_trade_broadcast_srqs_related_trade_id_grp_comp_remaining;
    ...
    bit<8> tes_upload_broadcast_srqs_related_trade_id_grp_comp_remaining;
}
...
struct headers_t {
    ...
    tes_approve_broadcast_srqs_related_trade_id_grp_comp_t tes_approve_broadcast_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
    ...
    tes_broadcast_srqs_related_trade_id_grp_comp_t tes_broadcast_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
    ...
    tes_trade_broadcast_srqs_related_trade_id_grp_comp_t tes_trade_broadcast_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
    ...
    tes_upload_broadcast_srqs_related_trade_id_grp_comp_t tes_upload_broadcast_srqs_related_trade_id_grp_comp[MAX_MESSAGES];
...
parser EurexT7EtiServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state read_tes_approve_broadcast_underlying_stip_grp_comp {
        ...
        transition select(meta.tes_approve_broadcast_underlying_stip_grp_comp_remaining) {
            8w0: read_tes_approve_broadcast_srqs_related_trade_id_grp_comp;
    ...
    state read_tes_approve_broadcast_srqs_related_trade_id_grp_comp {
        meta.tes_approve_broadcast_srqs_related_trade_id_grp_comp_remaining = hdr.tes_approve_broadcast.no_srqs_related_trade_i_ds;
        transition select(meta.tes_approve_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_approve_broadcast_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_tes_approve_broadcast_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.tes_approve_broadcast_srqs_related_trade_id_grp_comp.next);
        meta.tes_approve_broadcast_srqs_related_trade_id_grp_comp_remaining = meta.tes_approve_broadcast_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.tes_approve_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_approve_broadcast_srqs_related_trade_id_grp_comp;
        }
    ...
    state read_tes_broadcast_underlying_stip_grp_comp {
        ...
        transition select(meta.tes_broadcast_underlying_stip_grp_comp_remaining) {
            8w0: read_tes_broadcast_srqs_related_trade_id_grp_comp;
    ...
    state read_tes_broadcast_srqs_related_trade_id_grp_comp {
        meta.tes_broadcast_srqs_related_trade_id_grp_comp_remaining = hdr.tes_broadcast.no_srqs_related_trade_i_ds;
        transition select(meta.tes_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_broadcast_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_tes_broadcast_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.tes_broadcast_srqs_related_trade_id_grp_comp.next);
        meta.tes_broadcast_srqs_related_trade_id_grp_comp_remaining = meta.tes_broadcast_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.tes_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_broadcast_srqs_related_trade_id_grp_comp;
        }
    ...
    state parse_tes_trade_broadcast {
        ...
        meta.dispatched = 1;
        meta.tes_trade_broadcast_srqs_related_trade_id_grp_comp_remaining = hdr.tes_trade_broadcast.no_srqs_related_trade_i_ds;
        transition select(meta.tes_trade_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_trade_broadcast_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_tes_trade_broadcast_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.tes_trade_broadcast_srqs_related_trade_id_grp_comp.next);
        meta.tes_trade_broadcast_srqs_related_trade_id_grp_comp_remaining = meta.tes_trade_broadcast_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.tes_trade_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_trade_broadcast_srqs_related_trade_id_grp_comp;
        }
    ...
    state read_tes_upload_broadcast_underlying_stip_grp_comp {
        ...
        transition select(meta.tes_upload_broadcast_underlying_stip_grp_comp_remaining) {
            8w0: read_tes_upload_broadcast_srqs_related_trade_id_grp_comp;
    ...
    state read_tes_upload_broadcast_srqs_related_trade_id_grp_comp {
        meta.tes_upload_broadcast_srqs_related_trade_id_grp_comp_remaining = hdr.tes_upload_broadcast.no_srqs_related_trade_i_ds;
        transition select(meta.tes_upload_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_upload_broadcast_srqs_related_trade_id_grp_comp;
        }
    }

    state parse_tes_upload_broadcast_srqs_related_trade_id_grp_comp {
        packet.extract(hdr.tes_upload_broadcast_srqs_related_trade_id_grp_comp.next);
        meta.tes_upload_broadcast_srqs_related_trade_id_grp_comp_remaining = meta.tes_upload_broadcast_srqs_related_trade_id_grp_comp_remaining - 1;
        transition select(meta.tes_upload_broadcast_srqs_related_trade_id_grp_comp_remaining) {
            8w0: accept;
            default: parse_tes_upload_broadcast_srqs_related_trade_id_grp_comp;
        }
...
control EurexT7EtiServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.tes_approve_broadcast_srqs_related_trade_id_grp_comp);
        ...
        packet.emit(hdr.tes_broadcast_srqs_related_trade_id_grp_comp);
        ...
        packet.emit(hdr.tes_trade_broadcast_srqs_related_trade_id_grp_comp);
        ...
        packet.emit(hdr.tes_upload_broadcast_srqs_related_trade_id_grp_comp);
