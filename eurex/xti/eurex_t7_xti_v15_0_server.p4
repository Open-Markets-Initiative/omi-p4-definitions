...
parser EurexT7XtiServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w10903: parse_overall_risk_limits_definition_response;
            16w10902: parse_overall_risk_limits_report;
            ...
            16w10424: parse_rfq_reply_notification;
            16w10423: parse_rfq_reply_response;
            16w10402: parse_rfq_response;
            16w10419: parse_rfq_specialist_issuer_broadcast;
            ...
            16w10905: parse_trading_action_response;
