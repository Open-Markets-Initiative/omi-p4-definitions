// P4_16 (v1model) definition for: Eurex T7 Xti Fbe v13.1
// 
// Protocol:
...
//   Version: 13.1
//   Date: 3/7/2025
//   Specification: T7_R.13.1_Enhanced_Trading_Interface_-_Cash_Message_Reference_Version 2.pdf
// 
...
parser EurexT7XtiClientParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.message_header.template_id) {
            ...
            16w0xb528: parse_specialist_rfq_reject_request;
            16w0xb628: parse_specialist_rfq_reply_request;
