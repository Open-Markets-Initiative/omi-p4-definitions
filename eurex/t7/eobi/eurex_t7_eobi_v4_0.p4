// P4_16 (v1model) definition for: Eurex T7 Eobi Fbe v4.0
// 
// Protocol:
...
header execution_summary_t {
    ...
    bit<16> pad2;
    bit<64> last_px;
    bit<32> resting_hidden_qty;
    bit<32> resting_cxl_qty;
}
...
parser EurexT7EobiParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_instrument_summary {
        ...
        meta.dispatched = 1;
        meta.instrument_summary_md_instrument_entry_grp_comp_remaining = 16w11;
    ...
    state parse_trade_reversal {
        ...
        meta.dispatched = 1;
        meta.trade_reversal_md_trade_entry_grp_comp_remaining = 16w11;
