...
header basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_header_t {
    bit<64> transact_time;
    bit<64> basket_trd_match_id;
    bit<64> orig_basket_trd_match_id;
    bit<160> trade_report_id;
...
struct headers_t {
    ...
    basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_header_t basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_header;
...
parser EurexT7EtiServerParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    state read_basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp {
        packet.extract(hdr.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_header);
...
control EurexT7EtiServerDeparser(packet_out packet, in headers_t hdr) {
    apply {
        ...
        packet.emit(hdr.basket_roll_broadcast_old_basket_instrmt_match_side_grp_comp_header);
