// P4_16 (v1model) definition for: BlueOceanAts BlueEquities MemoirLastSale Sbe v1.3
// 
// Protocol:
...
parser BlueequitiesMemoirlastsaleParser(packet_in packet, out headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    state start {
...
control BlueequitiesMemoirlastsaleVerifyChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}
...
control BlueequitiesMemoirlastsaleEgress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    apply {
    }
}

control BlueequitiesMemoirlastsaleComputeChecksum(inout headers_t hdr, inout metadata_t meta) {
    apply {
    }
}

control BlueequitiesMemoirlastsaleDeparser(packet_out packet, in headers_t hdr) {
    apply {
...
V1Switch(
    BlueequitiesMemoirlastsaleParser(),
    BlueequitiesMemoirlastsaleVerifyChecksum(),
    BlueequitiesMemoirlastsaleIngress(),
    BlueequitiesMemoirlastsaleEgress(),
    BlueequitiesMemoirlastsaleComputeChecksum(),
    BlueequitiesMemoirlastsaleDeparser()
) main;
